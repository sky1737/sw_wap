...
//	->where(array('store_id' => $_GET['id']))->find();
//if (!empty($tmp_store['open_drp_limit']) && $_SESSION['user']['uid'] != $tmp_store['uid']) { //分销限制
...
//			pigcms_tips('亲，还差一步哦，在本店消费满 ' . $tmp_store['drp_limit_buy'] . '元，同时分享本店 ' . $tmp_store['drp_limit_share'] .
//				'次，即可申请成为本店分销商。', 'none');
//		}
