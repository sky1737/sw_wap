    ...
    if (!_checkSign($sign_key, $_POST)) {
        ...
        if (empty($_POST['username'])) {
            ...
            if (empty($_POST['password'])) {
                ...
                $userinfo = D('User')->field('uid,login_count')->where(array('phone'    => mysql_real_escape_string(trim($_POST['username'])),
                ...
                if (empty($userinfo)) {
                    ...
                    D('User')->where(array('uid' => $userinfo['uid']))->data(array('session_id'  => $session_id,
                                                                                   'last_time'   => time(),
