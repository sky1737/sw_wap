...
class LinkAction extends BaseAction
{
    ...
    {
        $t = array(
            array('module' => 'Home', 'linkcode' => str_replace('admin.php', 'wap', U('Wap/Home/index', '', true, false, true)), 'name' => '微站首页', 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => $this->modules['Home'], 'askeyword' => 1),
