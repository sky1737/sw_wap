        ...
        <td>
            <select name="parent_id">
                ...
                <volist name="categories" id="category">
                    <option value="{pigcms{$category.cat_id}"><?php if ($category['cat_level'] > 1) { echo str_repeat('|——', $category['cat_level']-1); } ?>{pigcms{$category.cat_name}</option>
                </volist>
            </select>
        </td>
    </tr>
            ...
            <div style="padding-bottom: 5px">
					<span>
						<select name="property_type[]" class="property_type"
                                onchange="change_property_type($(this))">
                            <option value="0">顶级分类</option>
                            <?php
                            foreach ($property_type as $tmp) {
                                ?>
                                <option
                                    value="<?php echo $tmp['type_id'] ?>"><?php echo $tmp['type_name'] ?></option>
                            <?php
                            }
                            ?>
                        </select>
