...
<form id="myform" method="post" action="{pigcms{:U('Slider/slider_amend')}" enctype="multipart/form-data">
    ...
    <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
        <tr>
            <th width="80">导航名称</th>
            <td><input type="text" class="input fl" name="name" value="{pigcms{$now_slider.name}" size="20"
        ...
        <tr>
            <th width="80">链接地址</th>
            <td><input type="text" class="input fl" name="url" value="{pigcms{$now_slider.url}" style="width:200px;"
