    ...
    <div id="nav" class="mainnav_title">
        <ul>
            ...
            <a href="javascript:void(0);"
               onclick="window.top.artiframe('{pigcms{:U('Ng_word/add')}','添加商城TAG',680,310,true,false,false,addbtn,'add',true);">添加敏感词</a>
        </ul>
    </div>
            ...
            if (count($ng_word_list) > 0) {
                foreach ($ng_word_list as $ng_word) {
                    ...
                    <tr class="propertys_tr">
                        ...
                        <td class="end_td">
                            <a href="javascript:"
                               onclick="window.top.artiframe('{pigcms{:U('Ng_word/edit', array('id' => $ng_word['id']))}', '编辑敏感词',400,200,true,false,false,false,'add',true);">修改</a>
                            <a href="javascript:" url="<?php echo U('Ng_word/delete', array('id' => $ng_word['id'])) ?>"
                               class="delete_row">删除</a>
                        </td>
                    </tr>
                <?php
                }
