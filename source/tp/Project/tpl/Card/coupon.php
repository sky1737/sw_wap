    ...
    <form name="myform" id="myform" action="" method="post">
        <div class="table-list">
            <table width="100%" cellspacing="0">
                ...
                <td>
                    <if condition="$list.attr eq '1'">赠送卷
                        <else/>
                        普通卷
                    </if>
                </td>
                ...
                <td class="button-column" nowrap="nowrap">
                    ...
                    <a class="green" style="padding-right:8px;"
                       href="{pigcms{:U('Card/coupon_edit', array('itemid'=>$list['id'],'id'=>$thisCard['id']))}">编辑</a>
                    |
                    <a title="删除" class="red" style="padding-right:8px;"
                       href="{pigcms{:U('Card/coupon_del',array('itemid'=>$list['id'],'id'=>$thisCard['id']))}">删除</a>
                </td>
                </tr>
                </volist>
                <tr>
