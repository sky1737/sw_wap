    ...
    <form name="myform" id="myform" action="" method="post">
        <div class="table-list">
            <table width="100%" cellspacing="0">
                ...
                <tr class="filters">
                    <td>
                        <form method="post" action=""><input name="searchkey" type="text" maxlength="20"/></form>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <if condition="$members">
                    <volist name="members" id="list">
                        <tr>
                            ...
                            <td>
                                <if condition="$list['getcardtime'] gt 0">{pigcms{$list.getcardtime|date='Y-m-d',###}
                                    <else/>
                                    无时间记录
                                </if>
                            </td>
                            <td>
                                ...
                                <form method="post"
                                      action="/admin.php?g=System&c=Card&a=memberExpense&id={pigcms{$thisCard.id}">
                            ...
                            <td class="button-column" nowrap="nowrap">
                                ...
                                <a title="删除" class="red" style="padding-right:8px;"
                                   href="{pigcms{:U('Card/member_del',array('itemid'=>$list['id'],'id'=>$thisCard['id']))}">删除</a>
                            </td>
                        </tr>
                    </volist>
                    <tr>
                        <td class="textcenter pagebar" colspan="8">{pigcms{$pagebar}</td>
                    </tr>
                    <else/>
                    <tr>
