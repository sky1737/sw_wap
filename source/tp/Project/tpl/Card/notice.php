                    ...
                    <volist name="list" id="item">
                        <tr>
                            ...
                            <td class="button-column" nowrap="nowrap">
                                ...
                                <a class="red"
                                   href="{pigcms{:U('Card/noticeDelete', array('noticeid'=>$item['id'], 'id' => $thisCard['id']))}">删除</a>
                            </td>
                        </tr>
                    </volist>
                    <tr>
                        <td class="textcenter pagebar" colspan="4">{pigcms{$pagebar}</td>
                    </tr>
                    <else/>
                    <tr>
                        <td class="textcenter red" colspan="4">列表为空！</td>
                    </tr>
                </if>
                </tbody>
            </table>
