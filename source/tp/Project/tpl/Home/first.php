    ...
    <form method="post" action="" enctype="multipart/form-data" id="myform">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
            <tr>
                ...
                <td>
                    <label><input type="radio" name="type" class="type" value="0"
                        <if condition="$first['type'] eq 0">checked</if>
                        >自定义文本</label>
                    <label><input type="radio" name="type" class="type" value="1"
                        <if condition="$first['type'] eq 1">checked</if>
                        >自定义图文</label>
                </td>
            </tr>
            <tr class="class_0"
            <if condition="$first['type'] neq 0">style="display:none"</if>
            >
            <th width="160">回复内容　</th>
            <td><textarea rows="20" cols="45" name="content" id="content">{pigcms{$first.content}</textarea></td>
            </tr>
            <tr class="class_1"
            <if condition="$first['type'] neq 1">style="display:none"</if>
            >
            ...
            <td>
                <input type="text" class="input-text" name="url" id="url" value="{pigcms{$first.url}"
                       style="width:200px;" placeholder="外链接url如：http://www.baidu.com" validate="maxlength:200,url:true"
                       tips="外链接url如：http://www.baidu.com"/>
