...
<form id="myform" method="post" action="{pigcms{:U('Sys_product_property/propertyValue_add')}"
      enctype="multipart/form-data">
    <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
        <tr>
            <th width="80">所属商品属性</th>
            <td>
                <select name="property_type_id" class="property_type_id" tips=""
        ...
        <tr>
            <th width="80">属性值</th>
            <td>
                <textarea rows="5" cols="25" name="values" id="values" placeholder="一行为一条记录"
