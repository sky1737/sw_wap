    ...
    if ($('#myform').length > 0) {
        if (document.getElementById('choose_map')) {
            ...
            $('#show_map_frame').click(function () {
                ...
                window.top.artiframe(choose_map + '&long_lat=' + $('#long_lat').val(), "地图选点", 655, 520, true, false, false, false, "choose_map", true, function () {
                    window.top.art.dialog.list["store_add"].position("50%", "38.2%");
                }, window.top.get_frame_position_left("store_add", 655));
            });
        }
