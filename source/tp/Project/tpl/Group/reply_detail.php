...
<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
    ...
    <tr>
        <th width="15%">评论编号</th>
        <td width="35%">{pigcms{$reply_detail.id}</td>
        <th width="15%">订单编号</th>
        <td width="35%"><a href="javascript:void(0);"
                           onclick="window.top.artiframe('{pigcms{:U('Group/order_edit',array('order_id'=>$reply_detail['order_id']))}','查看订单详情',600,460,true,false,false,false,'order_edit',true);">{pigcms{$reply_detail.order_id}</a>
        </td>
    </tr>
    </tr>
    <tr>
    <tr>
        ...
        <th width="15%">查看用户</th>
        <td width="35%"><a href="javascript:void(0);"
                           onclick="window.top.artiframe('{pigcms{:U('User/edit',array('uid'=>$reply_detail['uid']))}','查看用户信息',680,560,true,false,false,editbtn,'see_user',true);">查看用户信息</a>
        </td>
    </tr>
    </tr>
    <tr>
    ...
    <if condition="$image_list">
        <tr>
            ...
            <td colspan="3">
                <volist name="image_list" id="vo"><a href="{pigcms{$vo.image}" target="_blank"><img
                            src="{pigcms{$vo.s_image}" alt="评论图片" style="width:50px;"/></a>&nbsp;&nbsp;</volist>
            </td>
        </tr>
    </if>
    <tr>
