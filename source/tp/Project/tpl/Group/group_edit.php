...
<div class="mainbox">
    ...
    <form id="myform" method="post" action="{pigcms{:U('Group/amend')}" refresh="true">
        ...
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" id="tab_alipay">
            <tr>
                <th width="160">开启：</th>
                <td><span class="cb-enable"><label class="cb-enable "><span>开启</span><input type="radio"
                                                                                            name="pay_alipay_open"
                                                                                            value="1"/></label></span><span
                        class="cb-disable"><label class="cb-disable selected"><span>关闭</span><input type="radio"
                                                                                                    name="pay_alipay_open"
                                                                                                    value="0"
            ...
            <tr>
                <th width="160">帐号：</th>
                <td><input type="text" class="input-text" name="pay_alipay_name" id="config_pay_alipay_name"
                           value="partnerkeypartnerkey1" size="80" validate="" tips=""/></td>
            </tr>
            <tr>
                <th width="160">PID：</th>
                <td><input type="text" class="input-text" name="pay_alipay_pid" id="config_pay_alipay_pid"
                           value="partnerkeypartnerkey2" size="80" validate="" tips=""/></td>
            </tr>
            <tr>
                <th width="160">KEY：</th>
                <td><input type="text" class="input-text" name="pay_alipay_key" id="config_pay_alipay_key"
                           value="partnerkeypartnerkey3" size="80" validate="" tips=""/></td>
            </tr>
        </table>
        <div class="btn">
