...
<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
    ...
    <tr>
        ...
        <th width="15%">团购商品</th>
        <td width="35%"><a href="{pigcms{$now_order.url}" target="_blank" title="查看商品详情">{pigcms{$now_order.s_name}</a>
        </td>
    </tr>
    </tr>
    <tr>
    ...
    <tr>
        <th width="15%">订单类型</th>
        <td width="35%">
            <if condition="$now_order['tuan_type'] eq '0'">团购券
                <elseif condition="$now_order['tuan_type'] eq '1'"/>
                代金券
                <else/>
                实物
            </if>
    ...
    <if condition="$now_order['status'] eq 1">
        <tr>
            <th width="15%">
                <if condition="$now_order['tuan_type'] neq 2">消费
                    <else/>
                    发货
                </if>
                时间
