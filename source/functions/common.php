...
function __autoload($class)
{
	...
	else if(file_exists(TWIKER_PATH . 'library/controller/' . $class . '.php')) {
		require_once(TWIKER_PATH . 'library/controller/' . $class . '.php');

		return;
	}
	else if(file_exists(TWIKER_PATH . 'library/model/' . $class . '.php')) {
		require_once(TWIKER_PATH . 'library/model/' . $class . '.php');

		return;
	}
	else if(file_exists(TWIKER_PATH . 'library/class/' . $class . '.class.php')) {
		require_once(TWIKER_PATH . 'library/class/' . $class . '.class.php');

		return;
	}
	else if(file_exists(TWIKER_PATH . 'source/class/' . $class . '.class.php')) {
