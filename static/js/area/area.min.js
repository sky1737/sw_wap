...
function AreaCtrl(strP, strC, strA) {
	...
	if (this.level > 1) {
		this.html += '<span>' + strC + '<select name="City" id="city' + this.randomNum + '" ' + onchgCityStr + ' ></select></span>';
	}
	if (this.level > 2) {
		this.html += '<span>' + strA + '<select name="Area" id="area' + this.randomNum + '"></select></span>';
	}
