...
<title>供应中心 - <?php echo $now_store['name']; ?></title>
...
<div class="fixed">
	<nav class="tab-bar">
		...
		<section class="middle tab-bar-section">
			<h1 class="title">供应中心</h1>
		</section>
	</nav>
</div>
<div class="panel memberhead">
	<div class="header-l"> <i class="icon-level-dis"></i> </div>
	<div class="header-r"> <a href="./supplier_ucenter.php"> <span class="name"><?php echo $now_store['name']; ?></span>
		<br/>
		<i class="try-tip"><?php
...
include display('supplier_footer');
?>
<script>
