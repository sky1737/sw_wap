...
<title>粉丝列表 -<?php echo $now_store['name']; ?></title>
...
<div class="tabs-content" id="wrapper">
	<div id="scroller" class="content active">
		...
		<?php } ?>
		<div class="nocontent-tip" id="ordernull" <?php if ($fans_count > 0) { ?>style="display: none"<?php } ?>> <i class="icon-nocontent-laugh"></i>
			<p class="nocontent-tip-text"> 你还没有粉丝，<br>
				别人都开始数钱啦，快发展粉丝赚钱去！ </p>
		</div>
