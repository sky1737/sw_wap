...
<div class="wx_wrap">
    ...
    <!-- S 账户/积分 -->
    <div class="row count">
        <div class="small-6 large-3 columns mid" style="width:50%; float: left;"><a href="./balance.php?a=index"
                                                                                    class="count-a">
    ...
    <ul class="my_list">
        ...
        <li class="tiao"><a href="./trade.php?id=<?php echo $now_store['store_id']; ?>"><img
                    src="<?php echo TPL_URL; ?>images/tb/lljl.png" alt="">我的浏览记录</a></li><!---->
        <li class="hr"></li>
        <li class="tiao"><a href="./my_address.php"><img src="<?php echo TPL_URL; ?>images/tb/shdz.png"
                                                         alt="">收货地址管理</a></li>
        <?php
        if ($wap_user['stores'] > 0) { ?>
            <li class="hr"></li>
            <li class="tiao"><a href="./drp_ucenter.php"><img src="<?php echo TPL_URL; ?>images/tb/bwdj.png" alt="">我的商城</a>
            </li>
            <?php
        } ?>
    </ul>
