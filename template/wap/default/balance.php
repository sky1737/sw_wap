...
<div class="bro-spare">
	...
	<p class="field-2">积分：<big><?php echo $point; ?></big> &nbsp;(<a style="color:#999;font-size: .9em;" href="./balance.php?a=exchange">兑换余额</a>)</p>
	<p class="field-2">已提现总额：<big>￥<?php echo $cash; ?></big></p>
</div>
