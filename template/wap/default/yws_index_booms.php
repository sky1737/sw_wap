...
<head>
    ...
    <script>
        var keyword = '<?php echo $keyword;?>', key_id = '<?php echo $key_id;?>', suid = '<?php echo $supplier_uid;?>',is_boom='<?php echo $is_boom?>';
    </script>
    <script src="<?php echo TPL_URL; ?>index_style/js/category_boom.js"></script>
    <script>
        $(function () {
