				...
				foreach ($store_physical as $value) {
					...
					<div class="block block-order">
						...
						<div class="name-card name-card-3col name-card-store clearfix">
							...
							<a href="tel:<?php if ($value['phone1']) {
								echo $value['phone1'];
							} ?><?php echo $value['phone2']; ?>">
								<div class="phone"></div>
							</a>
							<a class="detail" href="./physical_detail.php?id=<?php echo $value['id']; ?>">
								<h3><?php echo $value['province_txt']; ?><?php echo $value['city_txt']; ?><?php echo $value['county_txt']; ?> <?php echo $value['address']; ?></h3>
								<?php if ($value['business_hours']) { ?><p class="c-gray-dark ellipsis"
								                                           style="margin-top:5px">
									营业时间：<?php echo $value['business_hours']; ?></p><?php } ?>
							</a>
						</div>
