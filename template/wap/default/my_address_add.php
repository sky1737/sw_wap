...
<div class="wx_wrap">
	<div class="address_new">
		<p><label for="name"><span class="tit">收货人</span><input type="text" id="name" name="name" value=""
		                                                        placeholder="名字"/></label></p>

		<p><label for="mobile"><span class="tit">手机号码</span><input type="tel" id="mobile" name="mobile" value=""
		                                                           placeholder="手机号码"></label></p>

		<p><label for="provinceId"><span class="tit">省份</span><span><select id="provinceId_m"
		                                                                    name="provinceId"></select></span></label>
		</p>
		...
		<p><label for="adinfo"><span class="tit">详细地址</span><input id="adinfo" name="adinfo" value="" type="text"
		                                                           placeholder="详细地址"></label></p>
...
<?php include display('public_menu'); ?><?php echo $shareData; ?>
