...
<div class="fixed">
	<nav class="tab-bar">
		<section class="left-small"> <a class="menu-icon" href="./agent.php"><span></span></a> </section>
...
<dl id="tabs_dl" class="tabs tab-title3" data-tab="">
	...
	<dd data-status="1" class="wb40"><a href="javascript:void(0)">已分销(<?php echo $drp_count; ?>)</a></dd>
</dl>
