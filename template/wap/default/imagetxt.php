...
<div class="rich_media container">
	...
	<div class="rich_media_inner content" style="min-height: 831px;">
		...
		<div class="rich_media_meta_list">
			...
			<a class="rich_media_meta link nickname js-no-follow js-open-follow" href="javascript:;"
			   id="post-user"><?php echo $weixin['nick_name']; ?></a>
		</div>
				...
				<div class="qr_code_pc_inner">
					<div class="qr_code_pc">
						<div class="qr_code_pc_img">
							<img width="158" height="158" src="<?php echo($weixin['alias'] ?
								'http://open.weixin.qq.com/qr/code/?username=' . $weixin['alias']
								: $weixin['qrcode_url']); ?>">
						</div>
						<p>
							微信扫一扫<br>获得更多内容
