...
<div class="container"> 
	...
	<div class="header">
				...
				<div class="headerbar-preview"> <span>预览：</span>
					<ul>
						...
						<li><a href="<?php echo $now_url; ?>&ps=540"
						   class="js-no-follow<?php if ($_GET['ps'] == '540') echo ' active'; ?>">三星Note3版</a> </li>
						<?php
		...
		<!-- ▼顶部通栏 -->
		<div class="js-mp-info share-mp-info"> <a class="page-mp-info" href="./"><!--<?php echo $now_store['url']; ?>-->
			<img
	...
	<div class="content">
		<div class="content-body">
				...
				<div class="swiper-container" style="height: 350px;">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide" style="height: 350px;">
							<a class="js-no-follow" href="javascript:;" style="height: 350px;"><img src="<?php echo $value['image']; ?>"/></a></div>
						<?php } ?>
					</div>
				</div>
			...
			<div class="goods-header">
				...
				<div class="item">
					<div class="row dotted">
						...
						<div class="col-4 t_right" style="padding: 0 0 0 10px; box-sizing: border-box; border-left: 1px solid #ddd;">
							<a class="btn-radius btn-default btn-outlet" href="<?php echo $drp_register_url; ?>"><i class="iconfont"></i><span>我要分销</span></a>
						</div>
					</div>
				</div>
		 ...
		 style="padding: 0px; text-align: left; margin-left: 10px; font-size: 12px; line-height: 14px;"> <span
				style="padding: 0px 5px; background: #fe5842; color: white; border-radius: 3px;">满减</span><?php echo $reward ?> </div>
				<?php
				}
				?>
				<div class="goods-price">
					...
					<span class="price-tag buyer-quota" data-buy-quantity="<?php echo $buy_quantity; ?>">限购<?php echo $nowProduct['buyer_quota']; ?> 件</span>
					<?php } ?>
				</div>
			</div>
			...
			<div class="sku-detail adv-opts" style="border-top: none;">
				<div class="sku-detail-inner adv-opts-inner">
					...
					<dl>
						<dt>运费：</dt>
						<dd> ¥ <?php echo $nowProduct['postage']; // $nowProduct['postage_tpl'] ? $nowProduct['postage_tpl']['min'] . '~' . $nowProduct['postage_tpl']['max'] : $nowProduct['postage'] ?></dd>
					</dl>
					<dl>
						<dt>立返：</dt>
						<dd><?php
			...
			<div class="js-components-container components-container">
				<div class="custom-store"> <a class="custom-store-link clearfix" href="./"><!--home.php?id=<?php echo $now_store['store_id']; ?>-->
					...
					<div class="call_store"> 联系卖家：
						<div class="inlineBlock storeContact" login-status="<?php echo empty($_SESSION['user'])?0:1;?>" open-url="<?php echo $imUrl; ?>" data-tel="<?php echo $now_store['tel'] ?>"></div>
					</div>
				</div>
				<div class="custom-recommend-goods js-custom-recommend-goods hide clearfix">
					<div class="custom-recommend-goods-title"> <a class="js-custom-recommend-goods-link" href="">推荐商品</a> </div>
				...
				<div>
					<div id="div_nav_fixed">
						<div class="div_nav" id="div_nav">
							<ul class="box">
								...
								<li style="border-right: 1px solid #ced3d7;"> <a href="javascript:;" class="on xuanxiangka">图文详情</a> </li>
					...
					<div class="div_sections" id="div_sections"> 
						...
						<section class="section_comments section_section" data-type="default">
							<div>
								<div class="tabber tabber_menu tabber-ios clearfix js-comment-tab"> <a class="active" style="border-right: 1px solid #fe5842" data-tab="0">好评</a> <a style="border-right: 1px solid #fe5842" data-tab="1">中评</a> <a style="width: 34%;" data-tab="2">差评</a> </div>
							</div>
							<div id="list_comments">
								<ul class="list_comments on" id="list_comments_0" data-page="1" data-type="default" next="true">
								</ul>
								<ul class="list_comments" id="list_comments_1" data-page="1" data-type="default" next="true">
								</ul>
								<ul class="list_comments" id="list_comments_2" data-page="1" data-type="default" next="true">
			...
			<div class="js-bottom-opts js-footer-auto-ele bottom-fix">
				...
				<?php }
				else if (empty($nowProduct['buy_way'])) { ?>
				<div class="btn-2-1"> <a href="./outside_good.php?id=<?php echo $nowProduct['product_id']; ?>" class="js-buy-it btn btn-orange-dark">去购买</a> </div>
				<?php }
				else if ($nowProduct['status'] == 1) { ?>
			...
			<div class="sidebar-section qrcode-info">
				<div class="section-detail">
					...
					<p class="text-center qr-code"> <img width="158" height="158"
					 src="<?php echo $config['site_url']; ?>/source/qrcode.php?type=good&id=<?php echo $nowProduct['product_id']; ?>"> </p>
				</div>
			</div>
		</div>
		<?php } ?>
...
<div class="popover popover-goods js-popover-goods">
	<div class="popover-inner">
		...
		<div class="js-async ui-goods-qrcode"> <img
				src="<?php echo $config['site_url']; ?>/source/qrcode.php?type=good&id=<?php echo $nowProduct['product_id']; ?>" alt="二维码" class="qrcode-img"/> </div>
	</div>
</div>
<script>
	$(function () {
