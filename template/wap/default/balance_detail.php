...
<title>资金记录 - <?php echo $config['site_name']; ?></title>
...
<script type="text/javascript">
	...
	var MaxPage_2 = Math.ceil(parseInt('<?php echo $cash_count; ?>') / PAGESIZE);
	var null_1 = '你还没有资金记录';
	var null_2 = '你还没有提现记录';
...
<dl id="tabs_dl" class="tabs tab-title2">
	<dd class="active" id="brokeragetab"> <a href="javascript:void(0)"><i class="icon-comdetail"></i>资金记录</a> </dd>
	<dd id="extracttab"> <a href="javascript:void(0)"><i class="icon-extract"></i>提现记录</a> </dd>
</dl>
<div class="tabs-content" id="wrapper">
	<div class="content active" id="brokeragelist scroller">
		...
		<div class="nocontent-tip" id="ordernull" style=""> <i class="icon-nocontent-worry"></i>
			<p class="nocontent-tip-text">你还没有资金记录</p>
		</div>
