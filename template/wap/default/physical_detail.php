<?php if (!defined('TWIKER_PATH')) exit('deny access!'); ?>
			...
			<div class="name-card name-card-3col name-card-store clearfix">
				<a href="javascript:;" class="thumb js-view-image-list">
					<?php foreach ($store_physical['images_arr'] as $image_key => $image_arr) { ?>
						<img class="js-view-image-item <?php if ($image_key != 0) {
							echo 'hide';
						} ?>" src="<?php echo $image_arr ?>"/>
					<?php } ?>
				</a>
				<a href="tel:<?php if ($store_physical['phone1']) {
					echo $store_physical['phone1'];
				} ?><?php echo $store_physical['phone2']; ?>">
					<div class="phone"></div>
				</a>
				...
				<div class="detail">
					...
					<p class="c-gray-dark ellipsis" style="margin-top: 1px">
						<?php if ($store_physical['business_hours']) { ?>营业时间：<?php echo $store_physical['business_hours']; ?>
							<br/><?php } ?>
						联系电话：<?php if ($store_physical['phone1']) {
							echo $store_physical['phone1'] . '-';
						} ?><?php echo $store_physical['phone2']; ?>
					</p>
	...
	<script type="text/javascript"
	        src="http://api.map.baidu.com/api?type=quick&ak=4c1bb2055e24296bbaef36574877b4e2&v=1.0"></script>
	<script type="text/javascript">
		...
		var infoWindow = new BMap.InfoWindow('<div class="infoWindow-content"><div class="address"><?php echo $store_physical['province_txt'];?><?php echo $store_physical['city_txt'];?><?php echo $store_physical['county_txt'];?> <?php echo $store_physical['address'];?></div><div class="navi"><a class="tag">到这里去</a><div class="js-navi-to navi-to"></div></div></div>', {
			title: '<?php echo $store_physical['name'];?>',
			width: 220,
			height: 80,
