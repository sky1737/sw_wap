				...
				<div class="headerbar">
					<div class="headerbar-wrap clearfix">
						...
						<div class="headerbar-reedit">
							<a href="<?php dourl('user:store:wei_page_category', array(),
								true); ?>#edit/<?php echo $nowCategory['cat_id'] ?>" class="js-no-follow">重新编辑</a>
						</div>
					</div>
				</div>
			<?php } ?>
				...
				<ul class="custom-nav custom-nav-noicon clearfix">
					...
					if ($pageList) {
						foreach ($pageList as $value) {
							?>
							<li>
								<a class="clearfix relative arrow-right"
								   href="<?php echo $config['wap_site_url']; ?>/page.php?id=<?php echo $value['page_id'] ?>"
								   target="_blank">
						...
						<div class="section-detail">
							...
							<p class="text-center qr-code">
								<img width="158" height="158"
								     src="<?php echo $config['site_url']; ?>/source/qrcode.php?type=page_cat&id=<?php echo $nowCategory['cat_id']; ?>">
							</p>
						</div>
					</div>
				</div>
