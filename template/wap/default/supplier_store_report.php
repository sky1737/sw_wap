...
<title>本店销售额 -<?php echo $now_store['name']; ?></title>
...
<div class="panel bro-yesterday">
	...
	<span><?php echo $now_store['sales']; ?></span> </div>
<dl class="tabs tab-title4-chart" data-tab="">
	<dd class="active"><a href="./supplier_report.php?a=sales#panel2-1" id="today">今日</a></dd>
	<dd><a href="./supplier_report.php?a=sales#panel2-2" id="yesterday">昨日</a></dd>
	<dd><a href="./supplier_report.php?a=sales#panel2-3" id="week">本周</a></dd>
	<dd><a href="./supplier_report.php?a=sales#panel2-4" id="month">本月</a></dd>
</dl>
	...
	<div class="content active" id="panel2-1">
		<div id="totaltoday" style="min-width: 100%; height: 400px; margin-top: 10px;" data-highcharts-chart="0">
			<div class="highcharts-container" id="highcharts-0"
			 style="position: relative; overflow: hidden; width: 1920px; height: 400px; text-align: left; line-height: normal; z-index: 0; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"> </div>
		</div>
	</div>
...
<input type="hidden" name="url" class="url" value="./supplier_report.php?a=sales"/>
<script>
