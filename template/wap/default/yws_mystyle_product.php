...
<head>
    ...
    <script>
        var keyword = '<?php echo $keyword;?>', key_id = '<?php echo $key_id;?>', suid = '<?php echo $supplier_uid;?>',cat_ids='<?php echo $cat_ids?>';
    </script>
    <script src="<?php echo TPL_URL; ?>index_style/js/yws_mystyle_gxdz.js"></script>
    <script>
        $(function () {
...
<div class="wx_wrap" style="padding-top:60px;">
    <div id="searchResBlock">
        ...
        <div class="s_empty hide" id="noMoreTips">已无更多商品，您可以换一个栏目看看哦~</div>
    </div>
</div>
<?php
$noFooterLinks = true;
