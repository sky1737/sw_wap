		...
		<form class="js-login-form " method="GET" action="<?php echo $redirect_uri; ?>">
			...
			<ul class="block block-form margin-bottom-normal">
				<li class="block-item">
					...
					<input id="phone" type="tel" name="phone" maxlength="11" class="js-login-phone" autocomplete="off"
					       placeholder="请输入您的手机号" value="">
				</li>
				<li class="block-item" style="margin-bottom: -1px">
					<label for="password">登录密码</label>
					<input id="password" type="password" name="password" autocomplete="off" class="js-login-pwd"
					       placeholder="请填写您的密码">
				</li>
			</ul>
