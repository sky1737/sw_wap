...
<div class="fixed">
	<nav class="tab-bar">
		...
		<section class="right-small right-small-text2" id="saveBtn" style="display: none">
			<a href="javascript:void(0)" onclick="btnsave()" class="button [radius round] top-button">保存</a></section>
	</nav>
</div>
<div class="personal-complete">
	...
	<div class="personal-center" id="divInfo">
		<ul class="side-nav" id="list">
			<!--<li isnew="False"> <a href="javascript:void(0)"><span class="user-tip-text"><i
						class="arrow-l"></i>此账号用于系统登录，填写后不可修改。</span>
				<div class="title  user-position"><i class="icon-name"></i><span class="text"
																				 tage="loginname">会员账号</span></div>
			...
			<li><a href="javascript:void(0)">
					<div class="title"><i class="icon-tname"></i><span class="text" tage="nickname">姓名</span></div>
					<div class="cont-value">
						<i class="arrow"></i><span class="value" id="nickname"><?php echo $user['nickname']; ?></span>
					</div>
				</a></li>
			<li><a href="javascript:void(0)">
					<div class="title"><i class="icon-mobile"></i><span class="text" tage="phone">手机</span></div>
					<div class="cont-value">
						<i class="arrow"></i><span class="value" id="phone"><?php echo $user['phone']; ?></span></div>
				</a></li>
			<li><a href="javascript:void(0)">
					<div class="title"><i class="icon-tname"></i><span class="text" tage="intro">简介</span></div>
					<div class="cont-value">
						<i class="arrow"></i><span class="value" id="intro"><?php echo $user['intro']; ?></span></div>
				</a></li>
...
<li>
		...
		<li> <a href="javascript:void(0)">
				<div class="title"><i class="icon-account-line"></i><span class="text"
																		  tage="ExtractAccount">提现账号</span></div>
				<div class="cont-value"> <i class="arrow"></i><span class="value long-text"><span></span><br>
					<span></span></span> </div>
				</a> </li>-->

		</ul>
	</div>
	<!--<div class="button-exit" id="exit"><a href="./drp_store.php?a=logout" class="button [radius red round]"
									  style="color: white;">退出登陆</a></div>-->
</div>
	...
	$(function () {
		...
		$("#list li").click(function () {
			...
			if (title == "收货地址") {
				...
				window.location.href = "./balance.php?a=withdraw_account";
			}
			else {
