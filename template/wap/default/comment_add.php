...
<head>
	...
	<style>
		...
		@-moz-animation-duration 0.15 s;
		@-ms-animation-duration 0.15 s;
		@-o-animation-duration 0.15 s;
	...
	<div class="shop_pinjgia_form">
			...
			<div class="shop_pingjia_form_list  appraise_li-list_top ">
				...
				<ul class="biaoqian">
					...
					foreach ($tag_list as $key => $tag) {
						?>
						<li>
							<input type="checkbox" class="ui-checkbox js-tag" id="tag_<?php echo $key ?>"
							       value="<?php echo $key ?>"/>
		...
		<div class="shop_pingjia_form_list  appraise_li-list_top " style="border:0;">
			...
			<div class="shop_pingjia_list">
				<ul>
					<li id="shop_add">
						<form enctype="multipart/form-data" id="upload_image_form" target="iframe_upload_image"
						      method="post" action="comment_attachment.php">
							<div class="updat_pic"><a href="javascript:" id="upload_message"><img
										src="<?php echo TPL_URL; ?>images/jiahao.png"/></a>
