			...
			<div class="content-body">
				<div class="custom-search">
					<form action="./search.php" method="get">
						...
						<input type="search" class="custom-search-input" placeholder="商品搜索：请输入商品关键字" name="q"
						       value="<?php echo $key; ?>"/>
				...
				<ul class="js-goods-list sc-goods-list clearfix list size-3">
					...
					if (!empty($goodList)) {
						...
						?>
						<li class="text-center">商品不存在。<a href="<?php echo $now_store['url']; ?>" class="more-link">去店铺主页看看？</a>
						</li>
					<?php
					}
					?>
