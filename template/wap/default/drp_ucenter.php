...
<div class="panel memberhead">
    ...
    <div class="header-r"> <!--<a href="./drp_store.php?a=account">--><span
            class="name"><?php echo $now_store['name']; ?></span>
        <br/>
        <!--<i class="try-tip"><?php
...
<div class="panel member-nav">
    <ul class="side-nav">
        <li><a href="./drp_team.php"><i class="icon-lowLevel"></i><span class="text">我的团队</span><i
                    class="arrow"></i></a>
        <li><a href="./drp_order.php?a=index"><i class="icon-disorder"></i><span class="text">分销订单</span><i
                    class="arrow"></i></a></li>
        ...
        <li class="last"><a href="app_z.php"><i class="icon-commission"></i><span class="text">云温商众筹</span><i
                    class="arrow"></i></a></li>
    </ul>
</div>
<?php
