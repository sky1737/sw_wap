			...
			if(result.err_msg){
				...
				$.each(result.err_msg,function(i,item){
					...
					$.each(item.product_list,function(j,jtem){
						near_content += '<li><a href="'+jtem.url+'"><div class="cover"><img src="'+jtem.image+'"/></div><p class="cost"><span class="price">'+jtem.price+'</span><!--span class="price_old">'+(jtem.market_price != '0.00' ? ''+jtem.market_price : '')+'</span--></p></a></li>';
					});
