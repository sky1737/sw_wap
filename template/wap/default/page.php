<?php if (!defined('TWIKER_PATH')) exit('deny access!'); ?>
	...
	<div class="container">
					...
					<div class="headerbar-wrap clearfix">
						...
						<div class="headerbar-reedit">
							<a href="<?php dourl('user:store:wei_page', array(),
								true); ?>#edit/<?php echo $nowPage['page_id'] ?>" class="js-no-follow">重新编辑</a>
						</div>
					</div>
				</div>
			<?php } ?>
		...
		<div class="content"
		     <?php if ($nowPage['bgcolor']){ ?>style="background-color:<?php echo $nowPage['bgcolor']; ?>;"<?php } ?>>
						...
						<div class="section-detail">
							...
							<p class="text-center qr-code">
								<img width="158" height="158"
								     src="<?php echo $config['site_url']; ?>/source/qrcode.php?type=page&id=<?php echo $nowPage['page_id']; ?>">
							</p>
						</div>
					</div>
				</div>
