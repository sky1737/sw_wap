	...
	<form name="editForm" id="profile" method="post" enctype="multipart/form-data" action="">
		<div id="J_editFormPane" class="kd-edit-form">
			...
			<div class="common-w1 user_message">
				...
				<div class="pr" style="/*position: absolute;right: 170px;top: 220px;width: 260px;*/">
					<table class="form-table3" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr>
								<td colspan="2" class="tit">用户头像</td>
							</tr>
							<tr>
					...
					<div style="color:#BFBFBF;">图片尺寸:300x300像素，小于 1M,图片大小：小于 1M,文件格式：JPG、JPEG、GIF、PNG</div></td>
							</tr>
							<tr>
								<td colspan="2" class="tit">联系方式</td>
							</tr>
							<tr>
								<td width="72"><label> <span class="red">*</span> 手机号码： </label></td>
							...
							<tr>
								<td><label>个人昵称：</label></td>
								<td><span class="td_nickname">
									<p id="nick_show" class="show_item"> <span><?php echo $user['nickname'] ?></span> &nbsp;&nbsp; <a href="JavaScript:void(0);" class="change_detail_edit cgreen"
								   onclicks="change_input(this,true,'nikename')">修改</a> <!--<span class="grey">个性昵称</span>--> &nbsp;&nbsp; <span class="grey"></span></p>
									</span> <span class="td_nickname" style="display:none">
									<input type="text" id="td_nickname_input"/>
									<a id="modtel" class="cgreen"
						                                                  href="javascript:void(0)">完成</a> </span></td>
							</tr>
							<tr>
								<td><label>个性签名：</label></td>
								<td><p id="postcode_show" class="show_item2"><span><?php echo $user['intro']; ?></span> <a
									href="JavaScript:void(0);" class="change_detail cgreen">修改</a> <span
									class="grey"></span> &nbsp;&nbsp; <span class="grey"></span></p>
									<span
								class="show_item2" style="display:none">
									<input type="text" id="postcode_show_input"/>
									<a class="cgreen"
						                                                    href="javascript:void(0)">完成</a> </span></td>
							</tr>
							<tr>
