			...
			<div class="danye_shop  clearfix">
				<div class="danye_shop_title">
					<div class="danye_shop_title_top clearfix"> 
						<!--  	<input type="checkbox" />-->
						<div class="shop_img"><a href="<?php echo url_rewrite('store:index',
									array('id' => $v['store_id'])) ?>" target="_blank"><img style="height:77px;width:77px;" src="<?php echo $v['logo'] ?>" /></a> </div>
					</div>
					<div class="danye_shop_txt"><a href="<?php echo url_rewrite('store:index',
								array('id' => $v['store_id'])) ?>" target="_blank"><?php echo $v['name']; ?></a></div>
					<ul>
						<li class=" clearfix">
						...
						<li class=" clearfix">
							<div class="danye_shop_list_tab">关注时间:<span><?php echo date("Y-m-d",
											$v['add_time']); ?></span></div>
						</li>
					</ul>
					<div class="danye_button">
						<button class="danye_go_shop cursor" style="display:none" onclick="javascript:location.href='<?php echo url_rewrite('store:index',
								array('id' => $v['store_id'])) ?>'">进入店铺 </button>
				...
				<div class="danye_shop_list">
					...
					<div class="danye_shop_list_table danye_product1">
						<div class="Div1 divScroll00">
							...
							<b class="Div1_prev Div1_prev1"><img src="images/lizi_img011.jpg" title="上一页" /></b> <b class="Div1_next Div1_next1"><img src="images/lizi_img012.jpg" title="下一页" /></b>
							<?php } ?>
							<div class="Div1_main">
								<style>
								...
								<ul style="height:159px;">
									...
									<li class="Div1_main_span1"> <a target="_blank" href="<?php echo url_rewrite('goods:index',
													array('id' => $v1['product_id'])) ?>" class="Div1_main_a1">
