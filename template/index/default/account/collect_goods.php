	...
	<div class="col-table">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tbody id="follow_table">
				...
				?>
				<tr id="tr_1159804448">
					<td><a target="_blank" href="<?php echo url_rewrite('goods:index',
							array('id' => $product['product_id'])) ?>"> <img width="100" height="100" src="<?php echo $product['image'] ?>" alt="<?php echo $product['name']; ?>"> </a></td>
					<td class="tb01"><div class="p-name"><a href="<?php echo url_rewrite('goods:index',
								array('id' => $product['product_id'])) ?>" target="_blank"><?php echo $product['name']; ?></a> </div>
					...
					<td><ul class="operating">
							<li><a id="buyCart_1159804448" class="btn-add" href="<?php echo url_rewrite('goods:index',
									array('id' => $product['product_id'])) ?>">我要购买</a></li>
