...
$(function () {
	...
	<style>
.category .cata_table dl dd.cata_curnt {
	color: #fff
}
</style>
...
<div class="content category">
    ...
    <dl>
          ...
          <dd><span></span></dd>
          <dd style="border:0px;"><a  style="border:0px;width:auto;" href="<?php echo  $categoryTree['tree']['son']['link'];?>"><?php echo $categoryTree['tree']['son']['cat_name']?></a> </span> </dd>
          <?php }?>
          <!--
            <dd><span></span></dd>
    ...
    <div class="menu_content">
        ...
        <dl>
              <!-- <dt>纸尿裤</dt>-->
              <dd><a href="javascript:void(0)">筛选 </a></dd>
    ...
    <div class="content_list">
        ...
        <li> <a href="<?php echo url_rewrite('goods:index', array('id' => $product['product_id'])) ?>">
            ...
            <!--<div class="shop_list">
              ...
              <div class="content_list_txt" style="padding-top:10px;">
            ...
            <div class="content_list_add">计算中</div>
              ...
              <div class="shop_info">
            <div class="content_shop_name">
                  <?php
										if (isset($store_list[$product['store_id']])) {
											?>
                  <a  href="<?php echo url_rewrite('store:index', array('id' => $product['store_id'])) ?>"><?php echo $store_list[$product['store_id']] ?>
                  <?php
										}
										?>
                </div>
