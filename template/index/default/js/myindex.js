		...
		function (obj) {
			for (var i in obj) {
				...
				for (var ii in obj[i].product) {
					...
					htmls += '<li> <a target="_blank" title="' + obj[i].product[ii].name + '" href="' + obj[i].product[ii].link + '"> <div class="content_list_img"><img width="224" height="159" onload="AutoResizeImage(224,159,this)"  src="' + obj[i].product[ii].image + '"> <div class="content_list_erweima"> <div class="content_list_erweima_img"><img src="' + weidian_code + '"></div> <div class="content_shop_name">微信扫码购买：' + obj[i].product[ii].name + '</div></div> </div><div class="content_list_txt"> <div class="content_list_pice">￥<span>' + obj[i].product[ii].price + '</span></div><div class="content_list_dec"><span>售' + obj[i].product[ii].sales + '/</span>分销' + obj[i].product[ii].drp_seller_qty + '</div> </div><div class="content_list_txt"> <div class="content_list_day">' + ddsj + ' </div><div class="content_list_add"><span></span>' + juli + '</div></div> </a> </li>';
				}
