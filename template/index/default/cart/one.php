...
<div class="order_content">
	<div class="Breadcrumbs"> 您的位置：<a href="/">首页</a> &gt; <a href="<?php echo url('user:account:index') ?>">会员中心</a> &gt; <a href="<?php echo url('user:account:order') ?>" class="current">我的订单</a> </div>
									...
									<td colspan="6">
										<div class="shop-detail-top-attrs">
											<span class="shop-detail-title">
												<input class="store_check" type="checkbox" value="<?php echo $key ?>" data-store-id="<?php echo $key ?>" checked="checked" />
								...
								<tr class="order-bd cart_list_<?php echo $key ?> js-order-detail">
									<td class="baobei">
										<label class="cart-chk">
											<input type="checkbox" name="id[]" class="j_cartItem" data-store-id="<?php echo $key ?>" value="<?php echo $cart['id'] ?>" checked="checked" />
										</label>
									...
									<td class="quantity">
										<span class="buyNum" data-cart-id="<?php echo $cart['id'] ?>">
											<span class="reduce" id="reduce"></span>
											<span class="add" id="add"></span>
											<input type="text" class="buyNumInput" id="buyNumInput" name="amout" value="<?php echo $cart['pro_num'] ?>" data-product_id="<?php echo $cart['id'] ?>" data-price="<?php echo $cart['pro_price'] ?>" old_value="<?php echo $cart['pro_num'] ?>" maxlength="8" />
											<span class="j_numError num_error"> ！超出购买上限 </span>
										</span>
									</td>
									<td class="ammout" rowspan="1">
										<b class="orange yen"> ¥</b>
										<b class="orange j_itemTotal" id="product_price_total_<?php echo $cart['id'] ?>"><?php echo $cart['pro_price'] * $cart['pro_num'] ?></b>
									</td>
									<td class="operate" rowspan="1">
										<a href="javascript:;" class="j_cartDel" data-cart-id="<?php echo $cart['id'] ?>">删除 </a>
									</td>
								</tr>
							<?php
								}
