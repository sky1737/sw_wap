...
if(!empty($pc_index_top)) {
	...
	echo '<div id="top_banner"><a href="' . $pc_index_top[0]['url'] . '"><img src="' . $pc_index_top[0]['pic'] . '" alt="" /></a></div>';
	echo '<script type="text/javascript">setTimeout(function(){$("#top_banner").slideToggle("slow");},10000);</script>';
	//}
