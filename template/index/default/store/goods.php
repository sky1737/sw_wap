...
<div class="shop_list_left">
	<div class="cata_table content_commodity" style="margin:0px auto 25px auto;">
		...
		<dl style="margin:0px 0px 25px 0px; border:0px; border-bottom:1px solid #e5e5e5;">
			...
			<dt style="margin-right:30px;"><input type="checkbox" id="self" name="self" value="1"<?php echo $self ? ' checked="checked"': ''; ?> /> <label for="self">自营</label></dt>
		</dl>
		<?php 
	...
	?>
		<style>
		.page_list .active{margin-right:5px; width:auto; padding:0 12px; height:36px; border:1px solid #ccc; cursor:pointer; background:rgb(245, 38, 72);display:inline-block; color:white}
		.page_list .fetch_page {margin-right:5px; width:auto; padding:0 15px; height:36px;border:1px solid #ccc; cursor:pointer;display:inline-block;}
		.page_list .fetch_page:hover {background:rgb(245, 38, 72); color:white;}
		</style>
