...
.content .content_shear .content_list_shear ul li .content_show { background: rgba(255, 255, 255, 0.5) none repeat scroll 0 0; word-wrap: break-word; }
.category .category_menu ul.menu_list li dl .menu_right { color: #191919; float: right; font-size: 12px; line-height: 20px; margin-top: 15px; width: 70px; }
</style>
</head>
...
<div class="shop_header">
			...
			<ul>
				<li>
					...
					<div class="shop_comment">
						<div class="shop_comment_bg" style="width:<?php echo $comment_type_count['satisfaction_pre'] ?>;"> </div>
					</div>
					<?php
					if ($store['approve']) {
					?>
	...
	<div class="shop_header_right"><img src="<?php echo $store['qrcode']['qrcode']; ?>" style="width:120px; height:119px;" />
		<p>微信访问</p>
	</div>
</div>
<?php
...
<div class="shop_content content category ">
	<div class="tab1 " id="tab1">
		<div class="menu js-menu">
			<ul>
				<li class="off" data-type="product">
					<div class="menu_border">商品货架 </div>
				</li>
				<li data-type="map">
					<div class="menu_border">查看地图 </div>
				</li>
				<li data-type="comment">
					<div class="menu_border">网友点评 </div>
				</li>
				<?php
			...
			<div id="con_one_4" style="display:none;" class="shopping_comment js-content-detail">
				<div class="shopping_conmment_content">
					...
					<div class="shopping_conmment_bottom"> 
						...
						<div class="zzsc">
							<div class="tab">
								<div class="tab_title"> <a href="javascript:;" class="on" data-tab="ALL">全部评价(<span><?php echo $comment_type_count['total'] ?></span>)</a> <a href="javascript:;" data-tab="HAO">满意(<span><?php echo $comment_type_count['t3'] + 0 ?></span>)</a> <a href="javascript:;" data-tab="ZHONG">一般(<span><?php echo $comment_type_count['t2'] + 0 ?></span>)</a> <a href="javascript:;" data-tab="CHA">不满意(<span><?php echo $comment_type_count['t1'] + 0 ?></span>)</a> </div>
								<div class="tab_form">
									<div class="form_sec">
										...
										<ul>
											<li class="red">
												<div class="appraise_li-list_top_icon manyi">
													<input type="radio" name="manyi" class="ui-checkbox" id="refund-reason00" checked="checked" value="5" />
													<label for="refund-reason00" ><span>满意</span></label>
												</div>
											</li>
											<li class="yellow">
												<div class="appraise_li-list_top_icon yiban">
													<input type="radio" name="manyi" class="ui-checkbox" id="refund-reason001" value="3" />
													<label for="refund-reason001" ><span>一般</span></label>
												</div>
											</li>
											<li class="gray">
												<div class="appraise_li-list_top_icon bumanyi">
													<input type="radio" name="manyi" class="ui-checkbox" id="refund-reason002" value="1" />
