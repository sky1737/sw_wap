...
<div class="order_content ">
	<div class="Breadcrumbs"> 您的位置：<a href="/">首页</a> &gt; <a href="<?php echo url('user:account:index') ?>">会员中心</a> &gt; <a href="<?php echo url('account:order') ?>" class="current">我的订单</a> </div>
	...
	<div class="order_contetn_add">
		<div class="order_order">
			...
			<div  class="order_info_list">
				<div class="order_info_title">
					...
					if ($order['shipping_method'] == 'selffetch') {
						if ($order_store['buyer_selffetch_name']) {
							echo ' <span>' . $order_store['buyer_selffetch_name'] . '</span>';
						} else {
							echo ' <span>到店自提</span>';
						}
			...
			<div  class="order_info_list">
				...
				<ul>
					<li>店铺名称：<?php echo $order_store['name'] ?></li>
				</ul>
			</div>
			<div  class="order_info_list">
