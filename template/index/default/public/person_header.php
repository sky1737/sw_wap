...
<script type="text/javascript">
		...
		location.href="<?php echo url('user:account:order') ?>&page=" + page;
	});
			</script>
<style type="text/css">
...
span.error { color: red; background: url(<?php echo TPL_URL;
?>images/weidian_icon_03.png) no-repeat center left;
padding-left: 20px; display: block; float: left; line-height: 25px }
span.success { color: green; background: url(<?php echo TPL_URL;
?>images/weidian_icon_05.png) no-repeat center left;
padding-left: 20px; float: left; display: block; line-height: 25px; }
#login-info li,
.common_div input { float: left }
	...
	<div role="navigation" id="site-nav">
		...
		<div id="sn-bd"> <b class="sn-edge"></b>
			<div class="sn-container">
				...
				<p class="sn-login-info" id="login-info"> <em>Hi，欢迎来状元分销微店</em> <a target="_top" href="<?php echo url('account:login') ?>" class="sn-login">请登录</a> <a target="_top" href="<?php echo url('account:login') ?>" class="sn-register">免费注册</a> </p>
				<ul class="sn-quick-menu">
					...
					<li class="sn-mytaobao menu-item j_MyTaobao">
						<div class="sn-menu"> <a rel="nofollow" target="_top" href="<?php echo url('user:account:index') ?>" class="menu-hd" tabindex="0" aria-haspopup="menu-2" aria-label="右键弹出菜单，tab键导航，esc关闭当前菜单">我的账户<b></b></a>
							<div class="menu-bd" role="menu" aria-hidden="true" id="menu-2">
								<div id="myTaobaoPanel" class="menu-bd-panel"> <a rel="nofollow" target="_top" href="<?php echo url('user:account:index') ?>">个人设置</a><!-- <a rel="nofollow" target="_top" href="<?php echo url('account:password') ?>">修改密码</a>--> <a rel="nofollow" target="_top" href="<?php echo url('user:account:address') ?>">收货地址</a> </div>
							</div>
						</div>
					</li>
...
<div class="danye_menu">
	<ul>
		<li class="danye_index"><a href="<?php echo option('config.site_url');?>"><img src="<?php echo option('config.pc_usercenter_logo');?>"></a></li>
		<!--   <li class="danye_list"><a href="#">会员首页</a></li>-->
		<li class="danye_list"><a href="<?php echo dourl('user:account:index') ?>">会员中心</a></li>
...
<div id="userinfo" class="m m3 clearfix">
	...
	<div id="i-userinfo">
		...
		<div class="tongji-group">
			<div class="tongji-group-inner"> <span class="h4" style="color: #e86062;">0</span> <span class="h5">账户余额</span> </div>
		</div>
		<div class="tongji-group">
			<div class="tongji-group-inner"> <span class="h4" style="color: #e86062;">0</span> <span class="h5">账户积分</span> </div>
		</div>
		<div class="tongji-group">
			<div class="tongji-group-inner"> <span class="h4" >0</span> <span class="h5">收藏商品</span> </div>
		</div>
		<div class="tongji-group">
			<div class="tongji-group-inner"> <span class="h4">0</span> <span class="h5">收藏店铺</span> </div>
		</div>
		<div class="tongji-group">
			<div class="tongji-group-inner"> <span class="h4">0</span> <span class="h5">我的订单</span> </div>
		</div>
</div>
...
<div class="menu">
	...
	<!--<div class="danye_title order" ><span></span>推客中心<i></i></div>
	<ul>
		<li id="one1" onClick="location.href='<?php echo dourl('account:rebate') ?>'" <?php if($_GET['a']=='rebate'){?>class="off"<?php } ?>>佣金记录</li>
		<li id="one1" onClick="location.href='<?php echo dourl('account:fans') ?>'" <?php if($_GET['a']=='fans'){?>class="off"<?php } ?>>我的粉丝</li>
		<li id="one1" onClick="location.href='<?php echo dourl('account:cash') ?>'" <?php if($_GET['a']=='cash'){?>class="off"<?php } ?>>佣金提现</li>
	</ul>-->
	...
	<ul>
		...
		<li id="one5" onClick="location.href='<?php echo dourl('account:info') ?>'" <?php if($_GET['a']=='info'){?>class="off"<?php } ?>>个人资料</li>
	</ul>
