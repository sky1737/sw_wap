<?php
if (MODULE_NAME == 'account' && ACTION_NAME == 'login') {
	return;
}
//var_dump($location_qrcode);
?>
...
<?php
	if (!empty($location_qrcode)) { ?>
		<script type="text/javascript">
			...
			function check_location_status() {
				$.getJSON("<?php echo url('wxlocation:check_status');?>", {qrcode_id: '<?php echo $location_qrcode['location_qrcode_id']; ?>'}, function (res) {
	...
	<style type="text/css">
		.tankuang1 .tanchuang_guanbi{bottom: 215px;}
		.tankuang1 .tankuang_title{color: #feed61;font-size: 30px;line-height: 33px;margin-bottom: 30px;}
	</style>
	<script>
	...
	<div class="tankuang_content tankuang4 popup1 hqwz" style="display:none">
		<div class="shouji animated bounceInDown"><img src="<?php echo TPL_URL; ?>images/tankuang_4_20.png">
			...
			<div class="tankuang_erweima animated zoomIn"><img src="<?php echo $location_qrcode['qrcode']; ?>"></div>
		</div>
		...
		<div class="tankuang_button animated bounceInUp"><img src="<?php echo TPL_URL; ?>images/tankuang1_03.png"/>
		</div>
	...
	<div class="tankuang_content tankuang1 tankuang_button_xianshi myfx popup2">
		<div class="shouji animated fadeInDown"><img src="<?php echo TPL_URL; ?>images/tankuang1_06.png">
			<div class="erweima animated rotateIn"><img class="wx_image" src=""></div>
			<div class="shaoma animated fadeIn">扫描二维码注册分销</div>
		</div>
		...
		<div class="tanchuang_guanbi animated bounceIn"><img src="<?php echo TPL_URL; ?>images/tankuang_1_14.png"/>
		</div>
	</div>
	...
	<div class="tankuang_content tankuang2 tankuang_button_xianshi popup3 rmhd">
		<div class="shouji"><img src="<?php echo TPL_URL; ?>images/tankuang_2_18.png" class="animated flipInY"/>
			...
			<div class="erweima animated zoomIn "><img class="wx_image"
			                                           src="<?php echo TPL_URL; ?>images/tankuang_1_06.png"></div>
		...
		<div class="tanchuang_guanbi animated bounceInDown "><img src="<?php echo TPL_URL; ?>images/tankuang_2_55.png"/>
		</div>
		...
		<div class="tankuang_list animated fadeInUp ">
			...
			<div class="tankuang_txt_txt">
				利用节日营销，打造传播新方式。中秋微贺卡，支持商家定制祝福语、背景音乐、自定义上传logo。粉丝在接收到商家发出的微贺卡后，也可对祝福内容进行定制，并分享、转发。利用微贺卡，借助节日气氛，为商家带来爆炸式传播。”
			</div>
		</div>
	</div>
	...
	<div class="tankuang_content tankuang3 tankuang_button_xianshi yydb popup4">
		<div class="shouji animated zoomIn"><img src="<?php echo TPL_URL; ?>images/tankuang3_18.png">
			...
			<div class="erweima animated rubberBand"><img class="wx_image"
			                                              src="<?php echo TPL_URL; ?>images/tankuang_1_06.png"></div>
		...
		<div class="tankuang_list animated fadeIn ">
			...
			<div class="tankuang_txt">派送利润: <span> ￥35</span></div>
			<div class="tankuang_txt_txt">
				每个用户最低只需1元就有机会获得一件奖品。每个奖品分配对应数量的号码，每个号码价值1元，当一件奖品所有号码售出后，根据既定的算法计算出一个幸运号码，持有该号码的用户，直接获得该奖品。”
			</div>
		</div>
		<div class="tanchuang_guanbi animated bounceInUp  "><img src="<?php echo TPL_URL; ?>images/tuankuang3_56.png"/>
		</div>
	</div>
</div>
