...
.right-red-radius {background-color: #F55181;border-radius: 10px;}
...
<div class="header">
			...
			<div class="sn-container">
				...
				<p class="sn-login-info" id="login-info">
					<?php if (empty($user_session)) { ?>
						...
						<a target="_top" href="<?php echo url('account:login') ?>" class="sn-login">请登录</a><!--<?php echo url('account:login') ?>-->
						<a target="_top" href="<?php echo url('account:login') ?>" class="sn-register">免费注册</a><!--<?php echo url('account:register') ?>-->
					<?php
					}
					else {
						?>
						<em>Hi，<?php echo $user_session['nickname']; ?></em> <a target="_top" href="<?php echo url('account:logout') ?>" class="sn-register">退出</a>
					<?php } ?>
				</p>
				<ul class="sn-quick-menu">
					...
					<li class="sn-mytaobao menu-item j_MyTaobao">
						<div class="sn-menu">
							<a rel="nofollow" target="_top" href="<?php echo url('user:account:index') ?>" class="menu-hd" tabindex="0" aria-haspopup="menu-2" aria-label="右键弹出菜单，tab键导航，esc关闭当前菜单">我的账户<b></b></a>
							<div class="menu-bd" role="menu" aria-hidden="true" id="menu-2">
								<div id="myTaobaoPanel" class="menu-bd-panel">
									<a rel="nofollow" target="_top" href="<?php echo url('user:account:info') ?>">个人设置</a>
									<a rel="nofollow" target="_top" href="<?php echo url('user:account:password') ?>">修改密码</a>
									<a rel="nofollow" target="_top" href="<?php echo url('user:account:address') ?>">收货地址</a>
								</div>
							</div>
						</div>
					</li>
					<li class="sn-favorite menu-item">
						<div class="sn-menu">
							<a rel="nofollow" href="<?php echo url('user:account:collect_store') ?>" class="menu-hd" tabindex="0">我的收藏<b></b></a>
							<div class="menu-bd" role="menu" aria-hidden="true" id="menu-4">
								<div class="menu-bd-panel"><a rel="nofollow" href="<?php echo url('user:account:collect_goods') ?>">收藏的宝贝</a>
									<a rel="nofollow" href="<?php echo url('user:account:collect_store') ?>">收藏的店铺</a>
								</div>
							</div>
						</div>
					</li>
					<li class="sn-mobile">
						<a href="javascript:" class="sn-mobile-hover"> <i class="mui-global-iconfont-mobile"></i>微信版
							<div class="sn-qrcode">
								<div class="sn-qrcode-content">
									<img src="<?php echo option('config.wechat_qrcode'); ?>" width="175px" height="175px">
								</div>
								<p>扫一扫，定制我的微店！</p>
								<b></b>
							</div>
	...
	<div class="header_nav">
		<div class="header_logo cursor" onclick="javascript:location.href='<?php echo empty($store_session)?'/':'/?twid='.$store_session['store_id']; ?>'"><img src="<?php echo $config['site_logo']; //empty($store_session)? $config['site_logo'] :$store_session['logo']; ?>"></div>
			...
			<form class="pigSearch-form clearfix" onsubmit="return false" name="searchTop" action="" target="_top">
				...
				<!--<div class="header_search_left"><font>商品</font><span></span>
					<div class="header_search_left_list">
						<ul>
							<li listfor="product"
								<?php if (MODULE_NAME != 'search' && ACTION_NAME != 'store') {
				...
				<div class="header_search_input">
					<input class="combobox-input" name="" class="input" type="text" placeholder="请输入商品名、称地址等" value="<?php echo $searchKeyword; ?>">
				</div>
		...
		<div class="header_shop">
			<?php if (!empty($public_top_ad)) { ?>
				<a href="<?php echo $public_top_ad['url']; ?>"><img src="<?php echo $public_top_ad['pic']; ?>"></a>
			<?php } ?>
		</div>
	</div>
</div>
