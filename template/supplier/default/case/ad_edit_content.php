<div class="app-design clearfix">
    <div class="widget-app-board ui-box">
        ...
        <!--<div class="widget-app-board-control">
            <label class="js-switch ui-switch pull-right <?php if ($order_store['open_ad']) { ?>ui-switch-on<?php } else { ?>ui-switch-off<?php } ?>"></label>
        </div>-->
    </div>
...
<div style="display:none;" id="edit_data" position="<?php echo $order_store['ad_position'];?>" page="<?php echo $order_store['use_ad_pages'];?>"></div>
