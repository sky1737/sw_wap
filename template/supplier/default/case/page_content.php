		...
		<table class="ui-table ui-table-list" style="padding: 0px;">
			...
			<?php if (!empty($custom_pages)) { ?>
				...
				foreach ($custom_pages as $custom_page) {
					if (!$custom_page['store_id'] && !$_SESSION['system']) {
						continue;
					}
					?>
					<tr>
						...
						<td class="text-right">
							...
							<a href="javascript:void(0);" class="js-delete"
							   data-id="<?php echo $custom_page['page_id']; ?>">删除</a>
							<span>-</span>
							<a href="javascript:void(0);" class="js-rename"
							   data-id="<?php echo $custom_page['page_id']; ?>">改名</a>
						</td>
					</tr>
				<?php
				}
