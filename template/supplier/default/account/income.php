...
<script type="text/javascript">
	var load_url="<?php dourl('load');?>",
		add_url="<?php dourl('selffetch_modify');?>",
		get_url="<?php dourl('selffetch_get');?>",
		edit_url="<?php dourl('selffetch_amend');?>";
		status_url="<?php dourl('selffetch_status');?>", 
		settingwithdrawal_url = "<?php dourl('settingwithdrawal'); ?>", 
		applywithdrawal_url = "<?php dourl('applywithdrawal'); ?>", 
		delwithdrawal_url="<?php dourl('delwithdrawal'); ?>";
</script>
                ...
                <nav class="ui-nav">
                    <ul>
                        ...
                        <!--<li id="js-nav-settlement-trade">
                            <a href="#income_trade">交易记录</a>
                        </li>-->
                        <li id="js-nav-settlement-inoutdetail">
                            <a href="#income_details">收支明细</a>
                        </li>
                        <li id="js-nav-settlement-withdraw">
                            <a href="#income_withdraw">提现记录</a>
                        </li>
                    </ul>
                </nav>
