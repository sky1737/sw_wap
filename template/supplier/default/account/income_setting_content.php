				...
				<fieldset>
					<div class="form-top-info"> 
						<!--<div class="control-group">
                            ...
                            <div class="controls">
                                <p class="info-row"><?php echo $order_store['name']; ?></p>
                            </div>
                        </div>
						...
						<div class="control-group">
							...
							<div class="controls bank-map js-bank-map-region">
								<select class="bank_id" name="bank_id">
									<?php foreach ($banks as $bank) {
										echo '<option value="'.$bank['bank_id'].'"'.(empty($card)?'':($bank['bank_id']==$card['bank_id']?' selected="selected"':'')).'>'.$bank['name'].'</option>';
									} ?>
								</select>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" placeholder="准确填写银行卡开户银行，否则无法提现；" name="bank_name" id="bank_name" class="js_opening_bank" value="<?php echo $card['bank_name']; ?>" />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<div class="widget-account-pretty">
									<div class="widget-account-pretty-input">
										<input type="text" placeholder="只支持提现至借记卡，不支持信用卡和存折；" id="card_no" name="card_no" value="<?php echo $card['card_no']; ?>" class="js_bank_card" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" placeholder="准确填写银行卡开卡人姓名，否则无法提现；" id="card_user" name="card_user" class="js_bank_card_user" value="<?php echo $card['card_user']; ?>" />
							</div>
						</div>
						<!--<div class="control-group">
							...
							<div class="controls">
								...
								<input type="hidden" class="js-mobile" value="<?php echo $order_store['tel']; ?>" />
								<p class="c-gray">验证短信将发送到您绑定的手机：<?php echo $order_store['tel']; ?>，请注意查收</p>
							</div>
						</div>-->
						<div class="control-group">
							<div class="controls">
