...
<script type="text/javascript">
	var load_url = "<?php dourl('load');?>",
		save_url = "<?php dourl('attention_store'); ?>";

	$(function () {
		load_page('.app__content', load_url, {page: 'attention_store_content'}, '');
		...
		$(".js-delete").live('click',function () {
			...
			var url = "/index.php?c=collect&a=attention_cancel&id=" + $(this).attr("data-id") + "&type=2";
