...
<div class="goods-list">
    <div class="js-list-filter-region clearfix ui-box" style="position: relative;">
        <div>
            <h3 class="list-title js-goods-list-title">已售完的商品</h3>
            <div class="ui-block-head-help soldout-help js-soldout-help hide" style="display: block;">
                ...
                <div class="js-notes-cont hide">
                    <p>当商品的所有规格或者某一个规格的库存变为0时，将显示在已售完的商品列表中</p>
                </div>
            </div>
                ...
                <div class="chosen-container chosen-container-single" style="width: 0px;" title="">
                    ...
                    <div class="chosen-drop">
                        ...
                        <ul class="chosen-results">
                            ...
                            <?php  if(isset($product_groups)) foreach ($product_groups as $product_group) { ?>
        ...
        <table class="ui-table ui-table-list" style="padding: 0px;">
            ...
            <?php if(isset($products)) foreach ($products as $product) { ?>
                <tr>
                    ...
                    <td class="text-right">
                        <p><a href="javascript:void(0);" class="js-promotion-btn" data="<?php echo $product['product_id']; ?>">推广商品</a></p>
