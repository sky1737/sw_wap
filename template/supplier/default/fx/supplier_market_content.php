...
class="chosen-single" tabindex="-1"><span>所有类目</span>
		...
		<table class="ui-table ui-table-list" style="padding: 0px;">
			...
			<thead class="js-list-header-region tableFloatingHeaderOriginal">
				<tr class="widget-list-header">
					...
					<th class="cell-10 text-right">售价</th>
			...
			<tbody class="js-list-body-region">
				...
				<tr class="widget-list-item">
					...
					<td class="text-right"><p>￥<?php echo number_format($product['price'] - $product['cost_price'], 2, '.', ''); ?></p></td>
					...
					<td class="text-right"><p class="js-opts"> <a href="javascript:;" data-id="<?php echo $product['product_id']; ?>" class="js-cancel-to-fx">取消分销</a> </p></td>
				</tr>
				<?php } ?>
			</tbody>
			<?php } ?>
	...
	<div class="js-list-footer-region ui-box">
		...
		<div class="widget-list-footer">
			<div class="pull-left"> <a href="javascript:;" class="ui-btn js-batch-cancel-to-fx">批量取消分销</a> </div>
