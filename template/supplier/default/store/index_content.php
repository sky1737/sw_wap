...
<div class="js-app-inner app-inner-wrap hide" style="display: block;">
	<div id="js-store-board" class="ui-store-board">
		<dl class="clearfix">
			<dt class="js-store-board-logo ui-store-board-logo"> <a href="<?php dourl('setting:store'); ?>" <?php if (empty($store_session['logo'])) { ?>style="background-image:url(<?php echo TPL_URL;?>images/shop2.png!145x145.jpg);"<?php } else { ?>style="background-image:url(<?php echo $store_session['logo']; ?>);"<?php } ?>> <i class="hide" style="display: none;">修改</i> </a> </dt>
			<dd class="ui-store-board-desc">
				...
				<nav>
					...
					<p>手机扫码访问：</p>
					<p class="team-code"> <img src="./source/qrcode.php?type=home&id=<?php echo $store_session['store_id']; ?>" alt=""> </p>
					<p> <a class="js-help-notes-btn-copy" href="javascript:void(0);" data-clipboard-text="<?php echo 'http://'.$store_session['store_id'].'.'.$config['site_domain'];?>/wap/">复制页面链接</a> <a href="<?php echo 'http://'.$store_session['store_id'].'.'.$config['site_domain'];?>/wap/" target="_blank">电脑上查看</a> </p>
					</span> </nav>
			</dd>
		</dl>
	...
	<div id="js-overview" class="ui-overview">
		<div class="overview-group">
			<div class="overview-group-inner"> <span class="h4"><?php echo $store_pv_yesterday; ?></span> <span class="h5">昨日店铺浏览次数</span> </div>
		</div>
		<div class="overview-group">
			<div class="overview-group-inner"> <span class="h4"><?php echo $store_uv_yesterday; ?></span> <span class="h5">昨日店铺浏览人数</span> </div>
		</div>
		<div class="overview-group">
			<div class="overview-group-inner"> <span class="h4"><?php echo $goods_pv_yesterday; ?></span> <span class="h5">昨日商品浏览次数</span> </div>
		</div>
		<div class="overview-group">
			<div class="overview-group-inner"> <span class="h4"><?php echo $goods_uv_yesterday; ?></span> <span class="h5">昨日商品浏览人数</span> </div>
		</div>
		<!--<div class="overview-group">
			<div class="overview-group-inner"> <a class="h4" href="<?php dourl('store:wei_page'); ?>"><?php echo $wei_page_total; ?></a> <span class="h5">微页面</span> </div>
		</div>-->
		<div class="overview-group">
			<div class="overview-group-inner"> <a class="h4" href="<?php dourl('goods:index'); ?>"><?php echo $product_total; ?></a> <span class="h5">商品</span> </div>
		</div>
	</div>
	<div id="js-pageview" class="ui-block app-block-pageview">
		<div class="ui-block-head">
			<h3 class="block-title">流量趋势</h3>
			<div class="block-help"> <a href="javascript:void(0);" class="js-help-notes"></a>
		...
		<div class="ui-block-body has-border has-padding">
			<div class="js-body app-block-body-inner" id="chart-body" style="cursor: default;"> </div>
		</div>
	</div>
	<div id="js-pagerank" class="ui-block app-block-pagerank ui-block-no-data">
		...
		<div class="ui-block-body">
			...
			<div class="js-block-content ui-block-no-data-content">
				...
				<p> 您可以 <a href="<?php dourl('goods:create'); ?>">创建商品</a> 或 <a class="js-create-template" href="<?php dourl('wei_page'); ?>#create">创建微页面</a>，发送给您的微信粉丝。 </p>
			</div>
			<?php } ?>
		</div>
	</div>
