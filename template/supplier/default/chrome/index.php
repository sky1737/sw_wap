...
.box { width: 503px; height: 629px; overflow: hidden; margin: 10px auto auto; background:url(<?php echo TPL_URL;
?>images/chrome_bg.jpg) 0 0 no-repeat;
}
.contenter { padding: 17px 55px 17px 15px; text-align: center; }
.b_title { width: 236px; height: 236px; background:url(<?php echo TPL_URL;
?>images/chrome_oops.png) 0 0 no-repeat;
margin: 0 auto; text-indent: -99em; overflow: hidden; }
	...
	<div class="contenter">
		...
		<div class="b_content">
			...
			<div class="case">
				...
				<div class="content">因为拖拽式布局来装修页面，需要和手机达到一致效果才最好！<br/>
					Andriod、IOS系统手机浏览器恰恰使用了Chrome的浏览器内核！<br/>
					<br/>
				</div>
			</div>
		</div>
