...
<aside class="ui-sidebar sidebar">
	<nav>
		<ul>
			<li> <a class="ui-btn ui-btn-success" href="<?php dourl('create');?>">发布商品</a> </li>
		</ul>
		<h4>商品管理</h4>
		<ul>
			<li <?php if($select_sidebar == 'index') echo 'class="active"';?>> <a href="<?php dourl('index');?>">出售中的商品</a> </li>
			...
			<?php /*<li <?php if($select_sidebar == 'category') echo 'class="active"';?>> <a href="<?php dourl('category'); ?>">商品分组</a> </li>*/?>
		</ul>
		<h4>评论管理</h4>
		<ul>
