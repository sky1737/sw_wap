<form class="form-horizontal" style="">
	...
	<div class="control-group">
		...
		<div class="controls ui-regions js-regions-wrap" data-province="<?php echo $store_contact['province']?>" data-city="<?php echo $store_contact['city']?>" data-county="<?php echo $store_contact['county']?>"> <span>
