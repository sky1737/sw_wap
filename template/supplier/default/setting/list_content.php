	...
	<div class="ui-box">
		<div class="js-list-filter-region clearfix">
			<div class="widget-list-filter">
				<div class="ui-box dianpu"> <a class="ui-btn ui-btn-success" href="#physical_store">新建</a> </div>
			</div>
		</div>
		...
		<table class="ui-table ui-table-list physical_list">
			...
			<tbody class="js-list-body-region">
				...
				<tr class="widget-list-item">
					...
					<td><?php if($value['phone1']){ echo $value['phone1'].'-';}?>
						<?php echo $value['phone2'];?></td>
					<td><?php echo $value['business_hours'];?></td>
					<td class="dianpu"><a href="#physical_store_edit/<?php echo $value['id'];?>" class="js-edit">编辑</a> - <a href="javascript:;" class="js-delete" data-id="<?php echo $value['id'];?>">删除</a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
