...
<head>
<meta charset="utf-8"/>
<title>店铺信息 -<?php echo $store_session['name'] . '|' . $config['site_name']; ?></title>
		...
		<div class="app-inner clearfix">
			<div class="app-init-container">
				<div class="ui-nav dianpu">
					<ul>
						<li class="js-app-nav active info"> <a href="#info">店铺信息</a> </li>
						<li class="js-app-nav contact"> <a href="#contact">联系我们</a> </li>
						<li class="js-app-nav list"> <a href="#list">门店管理</a> </li>
						<li class="js-app-nav user"> <a href="#user">授权管理</a> </li>
					</ul>
				</div>
