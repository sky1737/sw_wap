                ...
                <fieldset>
                    ...
                    <div class="control-group bank-group">
                        ...
                        <div class="controls js-bank-list-region">
                            <ul>
                                <?php if (!empty($order_store['bank_id'])) { ?>
                                <li class="bank active" data-id="<?php echo $order_store['bank_id']; ?>" data-opening-bank="<?php echo $order_store['opening_bank']; ?>" data-user="<?php echo $order_store['bank_card_user']; ?>" data-card="<?php echo $order_store['bank_card']; ?>" data-type="<?php echo $order_store['withdrawal_type']; ?>" >
                                    <span class="bank_name"><?php echo $bank; ?> - <?php echo $order_store['opening_bank']; ?></span>
                                    ...
                                    <span class="c-gray account_name"><?php echo $order_store['bank_card_user']; ?>（****<?php echo substr($order_store['bank_card'], -4); ?>）</span>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
