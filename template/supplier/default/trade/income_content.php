    ...
    <div class="page-settlement">
        <div class="ui-box settlement-info">
            <div class="account-info">
                <img src="<?php echo $order_store['logo']; ?>" class="logo" />

                <div class="account-info-meta">
                    <div class="info-item">
                        <label>店铺名称：</label>
                        <span><?php echo $order_store['name']; ?></span>
                    </div>
                    <div class="info-item">
                        <label>收款账户：</label>
                        <span><?php if (!empty($order_store['bank_card_user'])) { ?><?php echo $order_store['bank_card_user']; ?><?php } else { ?>未填写<?php } ?></span>
                    </div>
                    <div class="info-item">
                        <label>银行卡号：</label>
                        <span><?php if (!empty($order_store['bank_card'])) { ?><?php echo $order_store['bank_card']; ?><?php } else { ?>未填写<?php } ?></span>
                        <?php if (!empty($order_store['bank_card'])) { ?>
            ...
            <div class="balance">
                ...
                <div class="balance-info">
                    ...
                    <div class="balance-content">
                        <span class="money"><?php echo $order_store['unbalance']; ?></span>
                        <span class="unit">元</span>
                    </div>
                </div>
                <div class="balance-info">
                    ...
                    <div class="balance-content">
                        <span class="money"><?php echo $order_store['balance']; ?></span>
                        <span class="unit">元</span>
                        ...
                        <a href="<?php if ($order_store['balance'] <= 0) { ?>javascript:;<?php } else { ?>#<?php if ($bind_bank_card) { ?>applywithdrawal<?php } else { ?>settingwithdrawal<?php } ?><?php } ?>" class="ui-btn ui-btn-primary pull-right <?php if ($order_store['balance'] <= 0) { ?>ui-btn-disabled<?php } else { ?>js-goto<?php } ?>" data-goto="renzheng">提现</a>
                    </div>
                </div>
