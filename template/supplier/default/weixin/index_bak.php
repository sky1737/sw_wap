		...
		<div class="app">
			<div class="app-inner clearfix">
				<div class="app-init-container">
					<nav class="ui-nav">
						<ul>
							<li id="js-nav-list-index" class="active"> <a href="">图文</a> </li>
							<!--li>
<a href="">高级图文</a>
</li-->
						</ul>
					...
					<div class="app__content js-app-main">
						<div>
							<div class="js-list-filter-region clearfix ui-box" style="position: relative;">
								<div> <a href="javascript:;" class="ui-btn ui-btn-primary js-create-template">新建图文</a> </div>
							</div>
							<div class="ui-box">
									...
									<tbody class="js-list-body-region">
										...
										<tr>
											<td><div class="ng">
													...
													<div class="ng-item">
														<div class="td-cont with-label"> <span class="label label-success">图文</span>
															<div class="text"> <a href="/alias=<?php echo $v['id'];?>" target="_blank" class="new-window" title="<?php echo $v['title']?>"><?php echo $v['title']?></a> </div>
														</div>
													</div>
													<?php 
}
if ($i < 1) {
?>
													<div class="ng-item view-more"> <a href="?alias=<?php echo $value[0]['id'];?>" target="_blank" class="td-cont clearfix new-window"> <span class="pull-left">阅读全文</span> <span class="pull-right">&gt;</span> </a> </div>
													<?php }?>
												</div></td>
...
if ($value['type']) {
?>
												<a href="/user.php?c=weixin&a=multi&id=<?php echo $key;?>">编辑</a>
												<?php  } else {?>
												<a href="/user.php?c=weixin&a=one&id=<?php echo $key;?>">编辑</a>
												<?php } ?>
												<span>-</span> <a href="javascript:void(0);" class="js-delete" data-id="<?php echo $key;?>">删除</a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
