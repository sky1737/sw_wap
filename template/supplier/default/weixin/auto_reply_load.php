...
<div class="app-init">
	<div class="app__content">
		<div class="weixin-normal">
			...
			<!-- list rule -->
				<div class="rule-group" data-id="<?php echo $list['id'];?>">
					<div class="rule-meta">
						<h3>
							<em class="rule-id">规则：</em>
							<span class="rule-name" id="rule-name-<?php echo $list['id'];?>"><?php echo $list['name']; ?></span>
							...
							<div class="rule-inner">
								...
								<div class="reply-container">
									...
									<ol class="reply-list">
										...
										<li data-id="<?php echo $v['id'];?>" id="reply-li-<?php echo $v['id'];?>">
