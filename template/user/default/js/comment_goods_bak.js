        ...
        $.post(get_qrcode_activity_url, {'comment_id': comment_id}, function(data){
            ...
            if (data) {
                ...
                for (i in data) {
                    ...
                    qrcode_arr[data[i]['id']] = '<img class="loading" src="./source/qrcode.php?type=good&id=' + comment_id + '&activity=' + data[i]['id'] + '" /><p>' + desc + '</p><div class="clearfix qrcode-links"><a class="pull-left" href="./source/qrcode.php?type=good&id=' + comment_id + '&activity=' + data[i]['id'] + '" download="true" target="_blank">下载二维码</a><a class="pull-right js-edit" data-id="' + data[i]['id'] + '" href="javascript:;">修改优惠</a></div>';
                }
            }
        ...
        $.post(save_qrcode_activity_url, {'comment_id': comment_id, 'buy_type': buy_type, 'type': type, 'discount': discount, 'price': amount, 'activity_id': activity_id}, function(data){
            ...
            if (data.code) {
                ...
                if (data.type == 'add') {
                    ...
                    qrcode_arr[data.data.id] = '<img class="loading" src="./source/qrcode.php?type=good&id=' + comment_id + '&activity=' + data.data.id + '" /><p>' + desc + '</p><div class="clearfix qrcode-links"><a class="pull-left" href="./source/qrcode.php?type=good&id=' + comment_id + '&activity=' + data.data.id + '" download="true" target="_blank">下载二维码</a><a class="pull-right js-edit" data-id="' + data.data.id + '" href="javascript:;">修改优惠</a></div>';
