	...
	list: function () {
		...
		if (typeof(is_sync_user) == 'undefined' || is_sync_user == '0' || is_sync_user == '') {
			return [
				...
				{type: "notice", val: "公告"}, 
				{type: "goods_group1", val: "分组模板1"}, 
				{type: "goods_group2",val: "分组模板2"}, 
				{type: "coupons", val: "优惠券"},
	...
	clickEvent: function (dom) {
		...
		clickArr['image_nav'] = function () {
			...
			if (dom.find('.control-group .custom-nav-4').size() == 0) {
				...
				domHtml.data({
					'navList': [{'title': '', 'prefix': '', 'url': '', 'name': '', 'image': ''}, {
						'title': '',
						'prefix': '',
						'url': '',
						'name': '',
						'image': ''
					}, {'title': '', 'prefix': '', 'url': '', 'name': '', 'image': ''}, {
						'title': '',
						'prefix': '',
						'url': '',
						'name': '',
