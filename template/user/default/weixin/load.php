								...
								<div class="ng">
									...
									<div class="ng-item">
										<div class="td-cont with-label">
											...
											<div class="text">
												<a href="<?php echo $info_url . $v['id'];?>" target="_blank" class="new-window" title="<?php echo $v['title']?>"><?php echo $v['title']?></a>
											</div>
										</div>
									</div>
									<?php
									...
									<div class="ng-item view-more">
										<a href="<?php echo $info_url . $value['list'][0]['id'];?>" target="_blank" class="td-cont clearfix new-window">
