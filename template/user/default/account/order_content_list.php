...
<div class="ui-box orders">
    ...
    <table class="ui-table-order">
        ...
        <tr>
            ...
            <th class="">单价/数量</th>
            <th class="pay-price-cell"><a href="javascript:;" class="orderby orderby_total"
                                          data-orderby="total">总价/实付金额</a></th>
        ...
        <tr class="header-row">
            <td colspan="2">
                <div style="color:#aaa;"> 订单号: <?php echo $order['order_no']; ?>&nbsp;
        ...
        <tr class="content-row">
            ...
            <td class="title-cell">
                ...
                <p class="goods-title"><a href="/goods/<?php echo $product['product_id']; ?>.html" target="_blank"
                                          class="new-window"
            ...
            <td class="pay-price-cell" rowspan="<?php echo count($order['products']); ?>">
                <div class="td-cont" style="text-align: left; margin-left:10px; height: 75px;">
                    ...
                    <div class="c-gray" style="float:left;">
                        ...
                        <p>￥<?php echo round($order['point'] * 1.00 / $config['point_exchange'], 2); ?> <span
                                class="c-gray"><?php //echo $order['point']; ?>积分抵现</span></p>
                    </div>
                </div>
</div>
