        ...
        <table class="ui-table ui-table-list" style="padding: 0px;">
            ...
            <tbody class="js-list-body-region">
                ...
                <tr class="widget-list-item">
                    ...
                    <td width="195"><?php echo $withdrawal['card_user']; ?> |
                        <span class="js-bank-detail" style="cursor: pointer;"><?php echo mb_substr($withdrawal['bank'], 0, 4, 'UTF-8'); ?>...<?php echo substr($withdrawal['card_no'], -4); ?><b class="caret" data-bank="<?php echo $withdrawal['name']; ?>" data-opening-bank="<?php echo $withdrawal['bank_name']; ?>" data-bank-card="<?php echo $withdrawal['card_no']; ?>" data-bank-account="<?php echo $withdrawal['card_user']; ?>"></b></span>
                        <br>
