...
<aside class="ui-sidebar sidebar">
	<nav>
		<ul>
			<li <?php if(in_array($select_sidebar,array('dashboard','statistics'))) echo 'class="active"';?>> <a href="<?php dourl('dashboard');?>">订单概况</a> </li>
			<li <?php if($select_sidebar == 'all') echo 'class="active"';?>> <a href="<?php dourl('all');?>">所有订单</a> </li>
			<?if($now_store['buyer_selffetch']) {?>
			<li <?php if($select_sidebar == 'selffetch') echo 'class="active"';?>> <a href="<?php dourl('selffetch'); ?>"><?php echo $store_session['buyer_selffetch_name'] ? $store_session['buyer_selffetch_name'] : '到店自提' ?>订单</a> </li>
			<li <?php if($select_sidebar == 'codpay') echo 'class="active"';?>> <a href="<?php dourl('codpay'); ?>">货到付款订单</a> </li>
			<?php }?>
			<?php /*<li <?php if($select_sidebar == 'pay_agent') echo 'class="active"';?>><a href="<?php dourl('pay_agent'); ?>">代付的订单</a></li>*/?>
			<li <?php if($select_sidebar == 'star') echo 'class="active"';?>> <a href="<?php dourl('star'); ?>">加星订单</a> </li>
		</ul>
		<ul>
