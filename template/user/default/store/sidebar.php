...
<aside class="ui-sidebar sidebar" style="min-height: 100%;">
	<nav>
		...
		<!--<h4>页面管理</h4>
		<ul>
			<li <?php if ($select_sidebar == 'wei_page') { ?>class="active"<?php } ?>><a href="<?php dourl('store:wei_page'); ?>">店铺模板/杂志</a></li>
			<?php /*<li <?php if ($select_sidebar == 'wei_page_category') { ?>class="active"<?php } ?>><a href="<?php dourl('store:wei_page_category'); ?>"><?php if($_SESSION['user']['admin_id']){?>行业分类<?php }else{?>微页面分类<?php } ?></a></li>*/?>
			<li <?php if ($select_sidebar == 'ucenter') { ?>class="active"<?php } ?>><a href="<?php dourl('store:ucenter'); ?>">会员主页</a></li>
			<?php /*<li <?php if ($select_sidebar == 'storenav') { ?>class="active"<?php } ?>><a href="<?php dourl('store:storenav'); ?>">店铺底部模板</a></li>*/?>
		</ul>
		<h4>通用模块</h4>
		<ul>
		...
		<ul class="dianpu_left">
			...
			<li class="<?php if ($select_sidebar == 'store') { ?>active<?php } ?> user"><a href="<?php dourl('setting:store'); ?>#user">授权管理</a></li>
			<?php /*<li <?php if ($select_sidebar == 'config') { ?>class="active"<?php } ?>><a href="<?php dourl('setting:config'); ?>">物流配置</a></li>*/?>
		</ul>
		</ul>
	</nav>
</aside>
