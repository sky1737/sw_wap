...
<head>
<meta charset="utf-8"/>
<title>页面杂志 - <?php echo $store_session['name']; ?>
	| <?php echo(empty($_SESSION['sync_store']) ? $config['site_name'] : '微店系统'); ?></title>
...
<script type="text/javascript">
	...
	var is_adminuser = <?php echo $_SESSION['user']['admin_id']?1:0; ?>;
</script>
