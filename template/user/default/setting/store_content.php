<form class="form-horizontal">
	<fieldset>
		<div class="control-group">
			...
			<div class="controls"> <span class="sink"><?php echo $company['name']; ?></span> </div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<?php } ?>
				<div class="js-team-name-text"> <span class="sink"><?php echo $store['name']; ?></span>
					<?php if (empty($store['edit_name_count'])) { ?>
		...
		<?php /*<div class="control-group">
			...
			<div class="controls"> <span class="sink"><?php echo $sale_category; ?></span> </div>
		</div>*/?>
		<div class="control-group">
			<label class="control-label">创建日期：</label>
			<div class="controls"> <span class="sink"><?php echo date('Y-m-d H:i:s', $store['date_added']); ?></span> </div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls" style="color:#f00;"> 客服使用对接平台上的“网页客服”功能 </div>
		</div>
		<?php } ?>
	</fieldset>
