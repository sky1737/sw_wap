<form class="form-horizontal" style="">
	<input type="hidden" name="id" value="<?php echo $store_physical['id']?>"/>
	<div class="control-group">
		<label class="control-label"> <em class="required">*</em> 门店名称： </label>
		<div class="controls">
	...
	<div class="control-group">
		<label class="control-label"> <em class="required">*</em> 所属区域： </label>
		<div class="controls ui-regions js-regions-wrap" data-province="<?php echo $store_physical['province']?>" data-city="<?php echo $store_physical['city']?>" data-county="<?php echo $store_physical['county']?>"> <span>
	...
	<div class="control-group">
		<label class="control-label"> <em class="required">*</em> 地图定位： </label>
		<div class="controls">
			...
			<div class="shop-map-container">
				<div class="left hide">
					<ul class="place-list js-place-list">
					</ul>
				</div>
	...
	<div class="control-group">
		<label class="control-label"> <em class="required">*</em> 门店照片： </label>
		<div class="controls">
			<div class="control-action js-picture-list-wrap">
				<ul class="app-image-list clearfix">
					...
					<li class="js-picture-btn-wrap" style="display:inline-block;float:none;vertical-align:top;"> <a href="javascript:;" class="add js-add-physical-picture">+加图</a> </li>
				</ul>
			</div>
		</div>
	</div>
