...
<div id="step-1" class="js-step">
	<div class="clearfix ui-box" style="display:none;">
		<div class="right"> <span class="help-icon"></span> 商品类目及类目细项， <a href="#" class="new-window">请点此查看详情</a> </div>
	</div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" maxlength="9" class="input-small" name="total_stock"
                                               value="0"/>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label class="checkbox inline"><input type="checkbox" name="hide_stock"
                                                                              value="0"/>页面不显示商品库存</label>
                        ...
                        <div class="info-group-cont vbox">
                            <div class="group-inner">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio" style="padding-top:0px;">
                                            <input id="js-unified-postage" type="radio" name="delivery" value="0"
                                                   checked="" style="margin-top:7px;"/>统一邮费
                                            <div class="input-prepend">
                                                <span class="add-on">￥</span><input type="text" name="postage"
                                        ...
                                        <label class="radio mat10">
                                            <input id="js-use-delivery" disabled="" type="radio" name="delivery"
                                                   value="1" style="margin-top:5px;"/>运费模版
                                            <div class="delivery-template" style="display: inline-block;">
                                                <div class="select2-container js-delivery-template" id="s2id_autogen1"
                                                     style="width: 200px;"><a href="javascript:void(0)"
                                                                              onclick="return false;"
                                                                              class="select2-choice select2-default"
                                                                              tabindex="-1">
                                                        <span class="select2-chosen">请选择运费模版...</span><abbr
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="select2-search">
                                                            <input type="text" autocomplete="off" autocorrect="off"
                                                                   ...
                                                                   class="select2-input" maxlength="12">
                                                        </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="weight" value="0" class="input-small js-weight"
                                    ...
                                    <div class="controls">
                                        ...
                                        <label class="radio mat5" for="sold_time">
                                            <input type="radio" id="sold_time" name="sold_time" value="1"
                                                   style="margin-top:7px;"/>定时开售
                                            <input id="start_sold_time" name="start_sold_time" readonly="readonly"
                                                   class="input-medium js-sold-time v-hide" type="text" value=""/>
                                        </label>
                                    </div>
                                </div>
                                <!--
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="checkbox inline">
                                            <input type="checkbox" name="is_fx" value="1" /> 加入分销市场
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                ...
                <div class="app-design clearfix">
                            ...
                            <div class="app-config">
                                ...
                                <div class="js-config-region">
                                    <div class="app-field clearfix editing">
                                        <div class="control-group">
                                            <div class="goods-details-block" style="background:#fff;"><h4>商品详情区</h4>
                                                <p>点击进行编辑</p></div>
                                        </div>
                                        <div class="actions">
                    ...
                    <div class="app-actions" style="bottom: 0px;">
                        <div class="form-actions text-center">
                            ...
                            <input class="btn btn-primary js-btn-load js-btn-save" type="button" data="putaway"
                                   value="上架" data-loading-text="上架...">
                            <input class="btn js-btn-unload js-btn-save" type="button" data="soldout" value="下架"
                                   data-loading-text="下架...">
                            <input class="btn js-btn-preview js-btn-save" type="button" value="预览" data="preview"
