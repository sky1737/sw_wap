<script>
	var sku_data = '<?php echo $sku_data; ?>';
</script>
		...
		<form class="form-horizontal fm-goods-info">
			<div id="step-1" style="display:none;" class="js-step">
				<div class="clearfix ui-box">
					<div class="right"><span class="help-icon"></span> 商品类目及类目细项，
						<a href="#" class="new-window">请点此查看详情</a></div>
				</div>
									...
									<div class="js-goods-klass">
										<div>
											<div class="widget-goods-klass">
												...
												$parent_category['cat_id'] == $value['cat_id']) { ?>
												<div
													...
													data-name="<?php echo $parent_category['cat_name']; ?>"> <span
				...
				<div id="step-2" class="js-step">
						...
						<div class="goods-info-group-inner">
							...
							<div class="info-group-cont vbox">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select class="js-tag chosen-select" name="tag" multiple=""
                                                    data-placeholder="选择商品分组" style="display:none;">
										</select>
										<div class="chosen-container chosen-container-multi" style="width:200px;">
											<ul class="chosen-choices">
												...
												<li class="search-choice"
                                                                data-id="<?php echo $value['group_id']; ?>"> <span><?php echo $value['group_name']; ?></span><a
                                                                    class="search-choice-close"></a></li>
												<?php } ?>
												<li class="search-field">
													<input type="text" value="选择商品分组" class="default"
                                                                   autocomplete="off" style="cursor:text;width:25px;"
                                                                   readonly="readonly"/>
												</li>
												<?php } else { ?>
												<li class="search-field">
													<input type="text" value="选择商品分组" class="default"
                                                                   autocomplete="off" style="cursor:text;width:103px;"
                                                                   readonly="readonly"/>
												</li>
												<?php } ?>
											</ul>
										...
										<p class="help-inline"> <a class="js-refresh-tag" href="javascript:;">刷新</a> <span>|</span> <a class="new_window" target="_blank"
                                                   href="<?php dourl('category'); ?>#create">新建分组</a> </p>
									</div>
								</div>*/ ?>
								</div>
							</div>
							...
							<div class="info-group-cont vbox">
								<div class="group-inner">
										...
										<div id="sku-region" class="controls">
											<div class="sku-group">
												<div class="js-sku-list-container">
													<div class="sku-sub-group"></div>
													<?php echo $prop_content; ?> </div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" maxlength="9" class="input-small" name="total_stock"
											       value="<?php echo $product['quantity']; ?>"
											       <?php if($product['has_property'] ||
											       !empty($product['supplier_id'])) { ?>readonly="true"<?php } ?> />
											&nbsp;&nbsp;&nbsp;&nbsp;
											<label class="checkbox inline">
												<input type="checkbox" name="hide_stock"
												       value="0"
												       <?php if(!$product['show_sku']) { ?>checked="true" <?php } ?> />
												页面不显示商品库存</label>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="input-small" name="goods_no"
											       value="<?php echo $product['code']; ?>" />
											<a style="display:none;" href="javascript:;"
											   class="js-help-notes circle-help">?</a></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="goods-info-group-inner">
							...
							<div class="info-group-cont vbox">
								<div class="group-inner">
									<div class="control-group">
										...
										<div class="controls">
											<input class="input-xxlarge" type="text" name="title"
											       value="<?php echo $product['name']; ?>" maxlength="100" />
										</div>
									</div>
									<?php if(empty($product['unified_price_setting']) ||
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="hidden" name="price"
												       value="<?php echo $product['price']; ?>" />
										<span class="price"
										      style="color: #f60;font-weight: bold;font-size: 14px">￥<?php echo $product['price']; ?></span>&nbsp;&nbsp;
												<div class="input-prepend"><span class="add-on">￥</span>
													<input type="text" class="input-small"
													       placeholder="原价：" name="origin"
													       <?php if($product['market_price'] >
													       0) { ?>value="<?php echo $product['market_price']; ?>"<?php } ?> />
												</div>
											</div>
													...
													<?php foreach ($images as $image) { ?>
														<li class="sort">
															<a href="<?php echo $image['image']; ?>" target="_blank">
																<img src="<?php echo $image['image']; ?>" /> </a>
															<a class="js-delete-picture close-modal small hide">×</a>
														</li>
													<?php } ?>
													<li><a href="javascript:;" class="add-goods js-add-picture">+加图</a>
													</li>
												</ul>
											</div>
									...
									<div
										class="js-buy-url-group control-group <?php if(!empty($product['buy_way'])) { ?>hide<?php } ?>">
										<label class="control-label"><em class="required">*</em>外部购买地址：</label>
										<div class="controls">
											<input type="text" name="buy_url" placeholder="http://"
											       <?php if($product['buy_url']) { ?>value="<?php echo $product['buy_url']; ?>"<?php } ?>
											       class="input-xxlarge js-buy-url" />
										</div>
									</div>
								</div>
							</div>
					...
					<div id="other-info-region" class="goods-info-group"
					     <?php if(empty($product['buy_way'])) { ?>style="display: none;"<?php } ?>>
						<div class="goods-info-group-inner">
							<div class="info-group-title vbox">
							...
							<div class="info-group-cont vbox">
								<div class="group-inner">
										...
										<?php if(empty($product['supplier_id'])) { ?>
											<div class="controls">
												<label class="radio" style="padding-top:0px;">
													<input id="js-unified-postage" type="radio" name="delivery"
													       value="0" style="margin-top:7px;"
													       <?php if(empty($product['postage_type'])) { ?>checked="true"<?php } ?> />
													统一邮费
													<div class="input-prepend"><span class="add-on">￥</span>
														<input type="text" name="postage"
														       class="input-small js-postage"
														       <?php if(empty($product['postage_type'])) { ?>value="<?php echo $product['postage'] >
														       0 ? $product['postage'] : '0.00'; ?>"
														       <?php } else { ?>value="0.00"<?php } ?> />
													</div>
												</label>
												<label class="radio mat10">
													<input id="js-use-delivery" disabled="" type="radio" name="delivery"
													       value="1" style="margin-top:5px;"
													       <?php if(!empty($product['postage_type'])) { ?>checked="true"<?php } ?> />
													运费模版
													<div class="delivery-template" style="display: inline-block;">
														<div class="select2-container js-delivery-template"
														     id="s2id_autogen1" style="width: 200px;"><a
																href="javascript:void(0)" onclick="return false;"
																class="select2-choice select2-default" tabindex="-1"> <span
																	class="select2-chosen">
												<?php if(!empty($postage_template)) { ?>
													<?php echo $postage_template['tpl_name']; ?>
												<?php }
												else { ?>
													请选择运费模版...
												<?php } ?>
														...
														<input type="hidden" name="delivery_template_id"
														       value="<?php echo $product['postage_template_id']; ?>"
														       class="js-delivery-template select2-offscreen"
														       tabindex="-1">
														<a class="js-refresh-delivery" href="javascript:;">刷新</a>
														<a href="<?php dourl('trade:delivery'); ?>" target="_blank"
														   class="new-window">+新建</a></div>
												</label>
											</div>
										<?php }
										else { ?>
											<div class="controls" style="color:orangered"> 该商品为分销商品，暂不支持修改运费、配送信息</div>
										<?php } ?>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="weight"
											       value="<?php echo $product['weight'] + 0 ?>"
											       class="input-small js-weight"
											       onkeyup="this.value=this.value.replace(/\D/g,'')"
											       onafterpaste="this.value=this.value.replace(/\D/g,'')" />
											<span class="gray">单位：克</span></div>
									</div>
									<div class="control-group">
										<label class="control-label">每人限购：</label>
										<div class="controls">
											<input type="text" name="quota"
											       value="<?php echo !empty($product['buyer_quota'])
												       ? $product['buyer_quota'] : 0; ?>"
											       class="input-small js-quota" />
											<span class="gray">0 代表不限购</span></div>
									</div>
									<div class="control-group">
														...
														<?php foreach ($fields as $field) { ?>
															<div class="message-item">
																<input type="text" name="field_name"
																       ...
																       class="input-mini message-input field-name"
																       maxlength="5" />
																<select
																	class="input-small message-input" name="field-type">
																	<option value="text"
																	        <?php if($field['field_type'] ==
																	        'text') { ?>selected="true"<?php } ?>> 文本格式
																	</option>
																	<option value="number"
																	        <?php if($field['field_type'] ==
																	        'number') { ?>selected="true"<?php } ?>> 数字格式
																	</option>
																	<option value="email"
																	        <?php if($field['field_type'] ==
																	        'email') { ?>selected="true"<?php } ?>> 邮件格式
																	</option>
																	<option value="date"
																	        <?php if($field['field_type'] ==
																	        'date') { ?>selected="true"<?php } ?>> 日期
																	</option>
																	<option value="time"
																	        <?php if($field['field_type'] ==
																	        'time') { ?>selected="true"<?php } ?>> 时间
																	</option>
																	<option value="id_no"
																	        <?php if($field['field_type'] ==
																	        'id_no') { ?>selected="true"<?php } ?>> 身份证号码
																	</option>
																	<option value="image"
																	        <?php if($field['field_type'] ==
																	        'image') { ?>selected="true"<?php } ?>> 图片
																	</option>
																</select>
																<label class="checkbox inline message-input">
																	<input type="checkbox" name="multi_rows"
																	       class="multi-rows" value="1"
																	       <?php if($field['multi_rows']) { ?>checked="true"<?php } ?> />
																	多行 </label>
																<label class="checkbox inline message-input">
																	<input type="checkbox" name="required"
																	       class="required" value="1"
																	       <?php if($field['required']) { ?>checked="true"<?php } ?> />
																	必填 </label>
																<a href="javascript:;"
																   class="js-remove-message remove-message">删除</a></div>
														<?php } ?>
													</div>
													<div class="message-add">
														<a href="javascript:;" class="js-add-message control-action">+
															添加字段</a></div>
												</div>
											</div>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="sold_time" value="0"
												       <?php if(empty($product['sold_time'])) { ?>checked="true"<?php } ?> />
												立即开售 </label>
											<label class="radio mat5" for="sold_time">
												<input type="radio" id="sold_time" name="sold_time" value="1"
												       style="margin-top:7px;"
												       <?php if(!empty($product['sold_time'])) { ?>checked="true"<?php } ?> />
												定时开售
												<input id="start_sold_time" name="start_sold_time" readonly
												       class="input-medium js-sold-time v-hide" type="text"
												       <?php if($product['sold_time']) { ?>value="<?php echo date('Y-m-d H:i:s',
													       $product['sold_time']); ?>"<?php } ?> />
											</label>
										</div>
									</div>
									<?php /*<div class="js-level-discount control-group control-group-notes-wrap">
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class="checkbox inline">
												<input type="checkbox" name="is_fx" value="1"<?php
												echo $product['is_fx'] != 0 ? ' checked="checked"'
													: ''; ?> /> 加入分销市场</label>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<label class="radio inline">
												<input type="radio" name="invoice" value="0"
												       <?php if(!$product['invoice']) { ?>checked="true"<?php } ?> />
												无 </label>
											<label class="radio inline">
										...
										<div class="controls">
											<label class="radio inline">
												<input type="radio" name="warranty" value="0"
												       <?php if(!$product['warranty']) { ?>checked="true"<?php } ?> />
												无 </label>
											<label class="radio inline">
				...
				<div id="step-3" style="display:none;" class="js-step">
					<div class="app-design clearfix">
								...
								<div class="app-config ">
									...
									<div class="js-config-region">
										<div class="app-field clearfix editing">
											...
											<div class="actions">
												<div class="actions-wrap"><span class="action edit">编辑</span></div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="app-sidebar" style="margin-top: 243px;">
							...
							<textarea rows="2" name="intro"
							          class="js-sub-title input-sub-title"><?php echo $product['intro']; ?></textarea>
							</div>
							<div class="arrow"></div>
						...
						<div class="app-actions" style="bottom: 0px;">
							<div class="form-actions text-center">
								...
								<input class="btn btn-primary js-btn-load js-btn-edit" type="button" data="putaway"
								       value="上架" data-product-id="<?php echo $product['product_id']; ?>"
								       data-loading-text="上架..." />
								<input class="btn js-btn-unload js-btn-edit" type="button" data="soldout" value="下架"
								       data-product-id="<?php echo $product['product_id']; ?>"
								       data-loading-text="下架..." />
								<input class="btn js-btn-preview js-btn-edit" type="button" value="预览" data="preview"
								       data-product-id="<?php echo $product['product_id']; ?>"
								       data-loading-text="预览效果..." />
							</div>
						</div>
					</div>
				</div>
