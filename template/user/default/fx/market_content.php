...
<div class="goods-list">
					...
					<div class="chosen-container chosen-container-single" style="width: 160px!important;" title=""><a
						...
						<div class="chosen-drop">
							<ul class="chosen-results">
								...
								<li class="active-result" style="" data-option-array-index="<?php echo $category['cat_fid']; ?>|<?php echo $category['cat_id']; ?>">
									<?php if ($category['cat_level'] > 1) { ?>
									<?php echo str_repeat('&nbsp;&nbsp;&nbsp;', $category['cat_level']) . '|-- ' . $category['cat_name']; ?>
									<?php } else { ?>
									<b><?php echo $category['cat_name'];?></b>
									<?php } ?>
								</li>
								<?php } ?>
							</ul>
		...
		<table class="ui-table ui-table-list" style="padding: 0px;">
			...
			<thead class="js-list-header-region tableFloatingHeaderOriginal">
				<tr class="widget-list-header">
					...
					<th class="cell-10 text-right">会员价</th>
			...
			<tbody class="js-list-body-region">
				...
				<tr class="widget-list-item">
					<td class="checkbox"><input type="checkbox" class="js-check-toggle" <?php if (in_array($product['product_id'], $fx_products)) { ?>disabled="true" <?php } ?> value="<?php echo $product['product_id']; ?>" /></td>
    ...
    <td class="text-right">
        ...
        <p>- ￥<?php echo number_format($product['max_fx_price'] - $product['cost_price'], 2, '.', ''); ?></p>
					...
					<td class="text-right"><p><?php echo $product['quantity']; ?></p></td>
					...
					/*
						...
						已添加
						<?php } else { ?>
						<a href="javascript:;" data-id="<?php echo $product['product_id']; ?>" class="js-add-to-shop">排除</a>
						<?php } ?>
					*/?></td>
				</tr>
				<?php } ?>
	...
	<div class="js-list-footer-region ui-box">
		...
		<div class="widget-list-footer">
			<div class="pull-left"> <a href="javascript:;" class="ui-btn js-batch-add-to-shop">批量排除</a> </div>
