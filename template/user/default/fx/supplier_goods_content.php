...
style="position: static; top: 0px; margin-top: 0px; left: 601.5px; z-index: 1; width: 850px;">
				...
				<tr>
					<th class="checkbox cell-35" colspan="3"> <label class="checkbox inline">
							<input type="checkbox" class="js-check-all">
							商品 </label>
					</th>
					<th class="cell-8 text-right" style="min-width: 68px; max-width: 68px;"> 库存 </th>
					<th class="cell-12" style="min-width: 102px; max-width: 102px;"> 创建时间 </th>
			...
			<tbody class="js-list-body-region">
				...
				<tr>
					<td class="checkbox"><input type="checkbox" class="js-check-toggle" value="<?php echo $product['product_id']; ?>"<?php echo $product['is_fx'] == -1 ? ' disabled="disabled"' : '';?> /></td>
					<td class="goods-image-td"><div class="goods-image js-goods-image "> <img src="<?php echo $product['image']; ?>"/> </div></td>
					<td class="goods-meta"><p class="goods-title"> <a href="<?php echo $config['wap_site_url']; ?>/good.php?id=<?php echo $product['product_id']; ?>"
target="_blank" class="new-window" title="<?php echo $product['name']; ?>"> <?php echo $product['name']; ?> </a> </p>
						<p><span class="goods-price"
goods-price="<?php echo $product['price']; ?>">￥<?php echo $product['price']; ?></span> </p></td>
					...
					<td class="text-right"><p class="js-opts"><?php
					echo $product['is_fx'] ==0 ? '<a href="javascript:;" data-id="'.$product['product_id'].'" class="js-apply-to-fx">申请分销</a>' : '待审';
					?> </p></td>
					<?php
/*<td class="text-right"><a href="javascript:;" data-id="<?php echo $product['product_id']; ?>"></a><span></span><p>
