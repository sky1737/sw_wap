<style type="text/css">
.dash-bar .info-group { float: left; width: 25.33%; padding-top: 18px; }
.widget .chart-body { height: 345px; }
.form-horizontal input { width: 206px!important; }
.form-actions input { width: auto!important; height: auto; }
</style>
...
<div class="dash-bar clearfix">
	<div class="js-cont">
		<div class="info-group">
			<div class="info-group__inner"> <span class="h4"> <a href="<?php dourl('goods'); ?>"><?php echo $fx_product_count; ?></a> </span> <span class="info-description">分销商品数</span> </div>
		</div>
		<div class="info-group">
			<div class="info-group__inner"> <span class="h4"> <a href="<?php echo dourl('order:all'); ?>">￥<?php echo $sales; ?></a> </span> <span class="info-description">销售额</span> </div>
		</div>
		<div class="info-group">
			<div class="info-group__inner"> <span class="h4"> <a href="<?php echo dourl('trade:income'); ?>">￥<?php echo $profit; ?></a> </span> <span class="info-description"> 佣金 <i>-</i> <a href="<?php echo dourl('trade:income'); ?>">提现</a> </span> </div>
		</div>
	</div>
</div>
