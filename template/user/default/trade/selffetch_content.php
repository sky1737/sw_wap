<div class="js-selffetch">
	...
	<div class="js-selffetch-list">
		<div class="ui-box">
			<?php echo $store_session['buyer_selffetch_name'] ? $store_session['buyer_selffetch_name'] : '上门自提' ?>前台显示名：<input type="text" name="buyer_selffetch_name" value="<?php echo htmlspecialchars($order_store['buyer_selffetch_name']) ?>" placeholder="例如：上门自提、到店消费" />
				...
				<tbody class="js-list-body-region">
					<?php foreach($store_physical as $value){ ?>
						<tr class="widget-list-item">
							...
							<td class="dianpu">
								<a href="<?php dourl('setting:store') ?>#physical_store_edit/<?php echo $value['id'];?>">编辑</a>
							</td>
